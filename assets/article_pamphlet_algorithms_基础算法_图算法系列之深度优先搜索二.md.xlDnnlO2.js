import{_ as t}from"./chunks/ArticleMetadata.IwlMn1X8.js";import{_ as c,D as r,o as p,c as o,I as d,w as h,k as l,a as u,R as g,b as v,e as m}from"./chunks/framework.412fhWlr.js";import"./chunks/md5.6OGdLw3O.js";const j=JSON.parse('{"title":"图算法系列之深度优先搜索（二）","description":"","frontmatter":{"title":"图算法系列之深度优先搜索（二）","author":"Herman","date":"2021/08/14 13:58","categories":["算法"],"tags":["深度优先搜索","图算法"]},"headers":[],"relativePath":"article/pamphlet/algorithms/基础算法/图算法系列之深度优先搜索二.md","filePath":"article/pamphlet/algorithms/基础算法/图算法系列之深度优先搜索二.md","lastUpdated":1723377986000}'),b={name:"article/pamphlet/algorithms/基础算法/图算法系列之深度优先搜索二.md"},f=l("h1",{id:"图算法系列之深度优先搜索-二",tabindex:"-1"},[u("图算法系列之深度优先搜索（二） "),l("a",{class:"header-anchor",href:"#图算法系列之深度优先搜索-二","aria-label":'Permalink to "图算法系列之深度优先搜索（二）"'},"​")],-1),_=g(`<p>在上篇中我们学习了深度优先搜索，知道了如何通过深度优先搜索在图中寻找路径；本篇我们继续一起来学习深度优先搜索算法的其他应用场景</p><h2 id="连通分量" tabindex="-1">连通分量 <a class="header-anchor" href="#连通分量" aria-label="Permalink to &quot;连通分量&quot;">​</a></h2><p>从一幅图中找出所有的连通分量，这是也是深度优先搜索的一个应用场景。什么是连通分量？这个定义在之前的文章中已有提到<a href="https://juejin.cn/post/6930395454739841037" target="_blank" rel="noreferrer">《如何检测社交网络中两个人是否是朋友关系（union-find算法）》</a></p><p>在这篇采用的是union-find算法实现的连通性检查，本篇我们将采用深度优先搜索的方式来找出图中的所有连通分量</p><h4 id="连通分量的api定义" tabindex="-1">连通分量的API定义 <a class="header-anchor" href="#连通分量的api定义" aria-label="Permalink to &quot;连通分量的API定义&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>public class DepthFirstCC {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre></div><h4 id="单元测试" tabindex="-1">单元测试 <a class="header-anchor" href="#单元测试" aria-label="Permalink to &quot;单元测试&quot;">​</a></h4><p><img src="https://tva1.sinaimg.cn/large/008eGmZEgy1gpnqoki2p7j30bs07wjr9.jpg" alt=""></p><p>构造这样一个图，连通分量的总数应该是3</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>@Test</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,31);function k(s,C,w,y,V,q){const e=t,i=r("ClientOnly");return p(),o("div",null,[f,d(i,null,{default:h(()=>{var n,a;return[(((n=s.$frontmatter)==null?void 0:n.aside)??!0)&&(((a=s.$frontmatter)==null?void 0:a.showArticleMetadata)??!0)?(p(),v(e,{key:0,article:s.$frontmatter},null,8,["article"])):m("",!0)]}),_:1}),_])}const T=c(b,[["render",k]]);export{j as __pageData,T as default};
