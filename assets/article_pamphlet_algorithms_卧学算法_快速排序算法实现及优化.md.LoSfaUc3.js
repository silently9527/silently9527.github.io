...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,23);function v(a,f,C,j,q,S){const i=t,e=c("ClientOnly");return p(),o("div",null,[k,h(e,null,{default:d(()=>{var n,s;return[(((n=a.$frontmatter)==null?void 0:n.aside)??!0)&&(((s=a.$frontmatter)==null?void 0:s.showArticleMetadata)??!0)?(p(),g(i,{key:0,article:a.$frontmatter},null,8,["article"])):y("",!0)]}),_:1}),_])}const P=r(b,[["render",v]]);export{T as __pageData,P as default};
