import{_ as s,c as a,o as n,aa as e}from"./chunks/framework.DlhgB44u.js";const b=JSON.parse('{"title":"01 CompletableFuture让你的代码免受阻塞之苦","description":"","frontmatter":{"title":"01 CompletableFuture让你的代码免受阻塞之苦","author":"Herman","updateTime":"2021-08-14 13:41","desc":"CompletableFuture让你的代码免受阻塞之苦","categories":"Java","tags":"Java8新特性/多线程","outline":"deep"},"headers":[],"relativePath":"Notes/No2TechColumn/01 Java/01 CompletableFuture让你的代码免受阻塞之苦.md","filePath":"Notes/No2TechColumn/01 Java/01 CompletableFuture让你的代码免受阻塞之苦.md","lastUpdated":1724595807000}'),p={name:"Notes/No2TechColumn/01 Java/01 CompletableFuture让你的代码免受阻塞之苦.md"},l=e(`<h4 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h4><p>现在大部分的CPU都是多核，我们都知道想要提升我们应用程序的运行效率，就必须得充分利用多核CPU的计算能力；Java早已经为我们提供了多线程的API，但是实现方式略微麻烦，今天我们就来看看Java8在这方面提供的改善。</p><hr><h4 id="假设场景" tabindex="-1">假设场景 <a class="header-anchor" href="#假设场景" aria-label="Permalink to &quot;假设场景&quot;">​</a></h4><p>现在你需要为在线教育平台提供一个查询用户详情的API，该接口需要返回用户的基本信息，标签信息，这两个信息存放在不同位置，需要远程调用来获取这两个信息；为了模拟远程调用，我们需要在代码里面延迟 1s;</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public interface RemoteLoader {</span></span>
