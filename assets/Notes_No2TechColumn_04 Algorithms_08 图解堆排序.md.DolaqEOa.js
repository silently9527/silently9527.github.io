...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="构造堆" tabindex="-1">构造堆 <a class="header-anchor" href="#构造堆" aria-label="Permalink to &quot;构造堆&quot;">​</a></h2><p>把一个输入的数组构建成一个堆有序，我们有两种方式：</p><ol><li>从左向右遍历数组，然后把调用swim()上浮操作保证指针左边的元素都是堆有序的，就和优先级队列的插入过一样</li><li>由于数组中的每个位置已经是堆的节点，我们可以从右向左调用sink()下沉操作构造堆，这个过程我们可以跳过子堆为1的元素，所以我们只需要扫描数组的一半元素。这种方式会更高效。</li></ol><p>例如：输入数组</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>a[]={8,3,6,1,4,7,2}</span></span></code></pre></div><p><img src="https://raw.githubusercontent.com/silently9527/images/main/05b58b16dfb449f7b8e1a0323ccf8e71~tplv-k3u1fbpfcp-zoom-1.image" alt=""></p><h2 id="下沉排序" tabindex="-1">下沉排序 <a class="header-anchor" href="#下沉排序" aria-label="Permalink to &quot;下沉排序&quot;">​</a></h2><p>下沉是堆排序的第二个阶段，我们把最大元素删除，然后放入到堆缩小后数组中空出来的位置，当操作完成所有的元素之后，整个数组将会是有序的</p><p>下沉排序演示过程（图未完全画完）：</p><p><img src="https://raw.githubusercontent.com/silently9527/images/main/66031114d70b4a3bb2bd98d220a7249a~tplv-k3u1fbpfcp-zoom-1.image" alt=""></p><h2 id="堆排序代码实现" tabindex="-1">堆排序代码实现 <a class="header-anchor" href="#堆排序代码实现" aria-label="Permalink to &quot;堆排序代码实现&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>@Override</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,21),l=[i];function t(o,c,r,h,d,u){return n(),s("div",null,l)}const k=a(p,[["render",t]]);export{b as __pageData,k as default};
