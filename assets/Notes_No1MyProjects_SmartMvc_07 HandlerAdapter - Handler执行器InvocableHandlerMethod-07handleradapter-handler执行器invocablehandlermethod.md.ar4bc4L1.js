import{_ as n,c as s,o as e,aa as a}from"./chunks/framework.d_Ke7vMG.js";const m=JSON.parse('{"title":"07 HandlerAdapter - Handler执行器","description":"","frontmatter":{"title":"07 HandlerAdapter - Handler执行器","author":"Herman","updateTime":"2021-08-14 13:41","desc":"深入解析SpringMVC核心原理：从手写简易版MVC框架开始(SmartMvc)","categories":"MyProjects","tags":"SpringMvc/MVC","outline":"deep"},"headers":[],"relativePath":"Notes/No1MyProjects/SmartMvc/07 HandlerAdapter - Handler执行器InvocableHandlerMethod-07handleradapter-handler执行器invocablehandlermethod.md","filePath":"Notes/No1MyProjects/SmartMvc/07 HandlerAdapter - Handler执行器InvocableHandlerMethod-07handleradapter-handler执行器invocablehandlermethod.md","lastUpdated":1723563552000}'),p={name:"Notes/No1MyProjects/SmartMvc/07 HandlerAdapter - Handler执行器InvocableHandlerMethod-07handleradapter-handler执行器invocablehandlermethod.md"},l=a(`<p>前面两篇我们开发完成了参数的解析器和返回值的处理器，本篇我们将开始开发<code>InvocableHandlerMethod</code>，<code>InvocableHandlerMethod</code>是对<code>HandlerMethod</code>的扩展，基于一组<code>HandlerMethodArgumentResolver</code>从请求上下文中解析出控制器方法的参数值，然后调用控制器方法。</p><p><code>InvocableHandlerMethod</code> 与 <code>HandlerMethod</code> 有区别呢？</p><ul><li><code>HandlerMethod</code> 在容器在启动过程中搜集控制器的方法，用于定义每个控制器方法</li><li><code>InvocableHandlerMethod</code> 用于处理用户的请求调用控制器方法，包装处理所需的各种参数和执行处理逻辑</li></ul><p><img src="https://raw.githubusercontent.com/silently9527/images/main/454993797-5fce2d5be2fd8_articlex" alt=""></p><h4 id="_9-1-开发步骤讲解" tabindex="-1">9.1 开发步骤讲解 <a class="header-anchor" href="#_9-1-开发步骤讲解" aria-label="Permalink to &quot;9.1 开发步骤讲解&quot;">​</a></h4><blockquote><p>本节源代码的分支：handlerAdapter-invocableHandlerMethod</p></blockquote><h5 id="invocablehandlermethod" tabindex="-1">InvocableHandlerMethod <a class="header-anchor" href="#invocablehandlermethod" aria-label="Permalink to &quot;InvocableHandlerMethod&quot;">​</a></h5><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class InvocableHandlerMethod extends HandlerMethod {</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>该单元测试的结果如下：</p><p><img src="https://raw.githubusercontent.com/silently9527/images/main/250316949-5fce36f464910_articlex" alt=""></p><ol start="2"><li>测试控制器的方法testViewName</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>@Test</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>解析的结果如下：</p><p><img src="https://raw.githubusercontent.com/silently9527/images/main/4219761408-5fce386947159_articlex" alt=""></p><h4 id="_9-3-总结" tabindex="-1">9.3 总结 <a class="header-anchor" href="#_9-3-总结" aria-label="Permalink to &quot;9.3 总结&quot;">​</a></h4><p>本篇的开发内容比较简单，主要是把前两篇开发的参数解析器和返回值处理器给串联起来完成方法的调用；下一篇我们将开始完成<code>HandlerAdapter</code>这个组件的最后研发</p><h4 id="_9-4-延展" tabindex="-1">9.4 延展 <a class="header-anchor" href="#_9-4-延展" aria-label="Permalink to &quot;9.4 延展&quot;">​</a></h4><p>开发完成本节的任务后，大家可以对照着去看看SpringMVC中的<code>ServletInvocableHandlerMethod</code>、<code>InvocableHandlerMethod</code>，比我们的实现多了哪些功能</p>`,29),t=[l];function r(o,i,c,d,u,h){return e(),s("div",null,t)}const g=n(p,[["render",r]]);export{m as __pageData,g as default};
