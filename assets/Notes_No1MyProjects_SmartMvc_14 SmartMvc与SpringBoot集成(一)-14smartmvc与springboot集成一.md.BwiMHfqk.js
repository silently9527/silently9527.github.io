import{_ as n,c as a,o as s,aa as e}from"./chunks/framework.d_Ke7vMG.js";const x=JSON.parse('{"title":"14 SmartMvc与SpringBoot集成(一)","description":"","frontmatter":{"title":"14 SmartMvc与SpringBoot集成(一)","author":"Herman","updateTime":"2021-08-14 13:41","desc":"深入解析SpringMVC核心原理：从手写简易版MVC框架开始(SmartMvc)","categories":"MyProjects","tags":"SpringMvc/MVC","outline":"deep"},"headers":[],"relativePath":"Notes/No1MyProjects/SmartMvc/14 SmartMvc与SpringBoot集成(一)-14smartmvc与springboot集成一.md","filePath":"Notes/No1MyProjects/SmartMvc/14 SmartMvc与SpringBoot集成(一)-14smartmvc与springboot集成一.md","lastUpdated":1723563552000}'),p={name:"Notes/No1MyProjects/SmartMvc/14 SmartMvc与SpringBoot集成(一)-14smartmvc与springboot集成一.md"},t=e(`<p><img src="https://raw.githubusercontent.com/silently9527/images/main/17c04f0ceefb408d83840f858f9e1741~tplv-k3u1fbpfcp-watermark.image" alt=""></p><p>由于SpringBoot默认的web框架就是SpringMVC，如果我们需要完成与SpringBoot的集成，就需要在IOC容器的基础上定制开发Web容器， 其次，SpringBoot使用的是嵌入式Web服务器，所以我们还需要开发驱动嵌入式Web服务器的容器；本篇主要就来完成这两个功能</p><h4 id="开发步骤讲解" tabindex="-1">开发步骤讲解 <a class="header-anchor" href="#开发步骤讲解" aria-label="Permalink to &quot;开发步骤讲解&quot;">​</a></h4><h5 id="webapplicationcontext" tabindex="-1">WebApplicationContext <a class="header-anchor" href="#webapplicationcontext" aria-label="Permalink to &quot;WebApplicationContext&quot;">​</a></h5><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public interface WebApplicationContext extends ApplicationContext {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre></div>`,19),l=[t];function i(r,c,o,v,b,d){return s(),a("div",null,l)}const S=n(p,[["render",i]]);export{x as __pageData,S as default};
