import{_ as t}from"./chunks/ArticleMetadata.4VTDl_qq.js";import{_ as c,D as o,o as p,c as d,I as r,w as u,k as i,a as h,R as b,b as f,e as m}from"./chunks/framework.412fhWlr.js";import"./chunks/md5.6OGdLw3O.js";const O=JSON.parse('{"title":"如何检测社交网络中两个人是否是朋友关系（union-find算法）","description":"","frontmatter":{"title":"如何检测社交网络中两个人是否是朋友关系（union-find算法）","author":"Herman","date":"2021/08/16 13:58","categories":["算法"],"tags":["数据结构","union-find算法"]},"headers":[],"relativePath":"article/pamphlet/algorithms/卧学算法/03-如何检测社交网络中两个人是否是朋友关系（union-find算法）.md","filePath":"article/pamphlet/algorithms/卧学算法/03-如何检测社交网络中两个人是否是朋友关系（union-find算法）.md","lastUpdated":1723379536000}'),q={name:"article/pamphlet/algorithms/卧学算法/03-如何检测社交网络中两个人是否是朋友关系（union-find算法）.md"},k=i("h1",{id:"如何检测社交网络中两个人是否是朋友关系",tabindex:"-1"},[h("如何检测社交网络中两个人是否是朋友关系 "),i("a",{class:"header-anchor",href:"#如何检测社交网络中两个人是否是朋友关系","aria-label":'Permalink to "如何检测社交网络中两个人是否是朋友关系"'},"​")],-1),g=b(`<h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>春节放假会了老家，停更了很多天，这是年后连夜肝出来的第一篇文章，先来聊聊春节放假期间发生的事，这次回家遇到了我学生时代的女神，当年她在我心目中那是</p><blockquote><p>&quot;出淤泥而不染、濯清涟而不妖&quot;</p></blockquote><p>没想到这次回家遇到了她，身体发福了，心目中女神的形象瞬间碎了，就好像达芬奇再次遇到了蒙娜丽莎</p><blockquote><p>&quot;菡萏香销翠叶残&quot;</p></blockquote><p>好了，言归正传。</p><p>有时候我们可以需要判断在大型网络中两台计算机是否相连，是否需要建立一条新的连接才能通信；或者是在社交网络中判断两个人是否是朋友关系（相连表示是朋友关系）。在这种应用中，通常我们可能需要处理数百万的对象和数亿的连接，如何能够快速的判断出是否相连呢？这就需要使用到union-find算法</p><h2 id="概念" tabindex="-1">概念 <a class="header-anchor" href="#概念" aria-label="Permalink to &quot;概念&quot;">​</a></h2><h4 id="相连" tabindex="-1">相连 <a class="header-anchor" href="#相连" aria-label="Permalink to &quot;相连&quot;">​</a></h4><p>假如输入一对整数，其中每个数字表示的是某种对象（人、地址或者计算机等等），整数对p,q理解为“p与q相连”，相连具有以下特性：</p><ul><li>自反性：p与p是相连的</li><li>对称性：如果p与q相连，那么q与p相连</li><li>传递性：如果p与q相连，q与r相连，那么p与r也相连</li></ul><blockquote><p>对象如何与数字关联起来，后面我们聊到一种算法符号表</p></blockquote><h4 id="等价类" tabindex="-1">等价类 <a class="header-anchor" href="#等价类" aria-label="Permalink to &quot;等价类&quot;">​</a></h4><p>假设相连是一个种等价关系，那么等价关系能够将对象划分为多个等价类，在该算法中，当且仅当两个对象相连时他们才属于同一个等价类</p><h4 id="触点" tabindex="-1">触点 <a class="header-anchor" href="#触点" aria-label="Permalink to &quot;触点&quot;">​</a></h4><p>整个网络中的某种对象称为触点</p><h4 id="连通分量" tabindex="-1">连通分量 <a class="header-anchor" href="#连通分量" aria-label="Permalink to &quot;连通分量&quot;">​</a></h4><p>将整数对称为连接，将等价类称作连通分量或者简称分量</p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/51cd832609504204877bdcf3b52e0292~tplv-k3u1fbpfcp-zoom-1.image" alt=""></p><h4 id="动态连通性" tabindex="-1">动态连通性 <a class="header-anchor" href="#动态连通性" aria-label="Permalink to &quot;动态连通性&quot;">​</a></h4><p>union-find算法的目标是当程序从输入中读取了整数对p q时，如果已知的所有整数对都不能说明p q是相连的，那么将这一对整数输出，否则忽略掉这对整数；我们需要设计数据结构来保存已知的所有整数对的信息，判断出输入的整数对是否是相连的，这种问题叫做动态连通性问题。</p><h2 id="union-find算法api定义" tabindex="-1">union-find算法API定义 <a class="header-anchor" href="#union-find算法api定义" aria-label="Permalink to &quot;union-find算法API定义&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>public interface UF {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre></div><ul><li>算法分析： 看起来quick-union算法比quick-find算法更快，因为union不需要为每对输入遍历整个数组， 考虑最佳情况下，find方法只需要访问一次数组就可以得到根触点，那么union方法的时间复杂度O(n)； 考虑到最糟糕的输入情况，如下图：</li></ul><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/17496e49c2a94903a42501b0d99e1ba2~tplv-k3u1fbpfcp-zoom-1.image" alt=""></p><p>find方法需要访问数组n-1次，那么union方法的时间复杂度是O(n²)</p><h2 id="加权quick-union算法" tabindex="-1">加权quick-union算法 <a class="header-anchor" href="#加权quick-union算法" aria-label="Permalink to &quot;加权quick-union算法&quot;">​</a></h2><p>为了保证quick-union算法最糟糕的情况不在出现，我需要记录每一个树的大小，在进行分量归并操作时总是把小的树连接到大的树上，这种算法构造出来树的高度会远远小于未加权版本所构造的树高度。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>public class WeightedQuickUnionImpl extends AbstractUF {</span></span>
...
<span class="line"><span>        return p;</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><ul><li>算法分析： 最坏的情况下，每次union归并的树都是大小相等的，他们都包含了2的n次方个节点，高度都是n，合并之后的高度变成了n+1，由此可以得出union方法的时间复杂度是O(lgN)</li></ul><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8c67501200314cc1855255eff1b2c2c1~tplv-k3u1fbpfcp-zoom-1.image" alt=""></p><h2 id="总结" tabindex="-1">总结 <a class="header-anchor" href="#总结" aria-label="Permalink to &quot;总结&quot;">​</a></h2><p>union-find算法只能判断出给定的两个整数是否是相连的，无法给出具体达到的路径；后期我们聊到图算法可以给出具体的路径</p><table><thead><tr><th>算法</th><th>union()</th><th>find()</th></tr></thead><tbody><tr><td>quick-find算法</td><td>N</td><td>1</td></tr><tr><td>quick-union算法</td><td>树的高度</td><td>树的高度</td></tr><tr><td>加权quick-union算法</td><td>lgN</td><td>lgN</td></tr></tbody></table><hr><h2 id="最后-点关注-不迷路" tabindex="-1">最后（点关注，不迷路） <a class="header-anchor" href="#最后-点关注-不迷路" aria-label="Permalink to &quot;最后（点关注，不迷路）&quot;">​</a></h2><p>文中或许会存在或多或少的不足、错误之处，有建议或者意见也非常欢迎大家在评论交流。</p><p>最后，<strong>写作不易，请不要白嫖我哟</strong>，希望朋友们可以<strong>点赞评论关注</strong>三连，因为这些就是我分享的全部动力来源🙏</p><blockquote><p>参考书籍：算法第四版</p></blockquote>`,53);function _(n,v,N,R,y,P){const l=t,e=o("ClientOnly");return p(),d("div",null,[k,r(e,null,{default:u(()=>{var s,a;return[(((s=n.$frontmatter)==null?void 0:s.aside)??!0)&&(((a=n.$frontmatter)==null?void 0:a.showArticleMetadata)??!0)?(p(),f(l,{key:0,article:n.$frontmatter},null,8,["article"])):m("",!0)]}),_:1}),g])}const z=c(q,[["render",_]]);export{O as __pageData,z as default};
