import{_ as i}from"./chunks/ArticleMetadata.XuUbZ1GH.js";import{_ as c,D as r,o as p,c as o,I as h,w as d,k as e,a as g,R as u,b as m,e as b}from"./chunks/framework.PNf1_BA9.js";import"./chunks/md5.c4H53MUT.js";const x=JSON.parse('{"title":"图算法系列之计算图中最短路径","description":"","frontmatter":{"title":"图算法系列之计算图中最短路径","author":"Herman","date":"2021/08/14 13:58","categories":["算法"],"tags":["广度优先搜索","图算法"]},"headers":[],"relativePath":"article/pamphlet/algorithms/卧学算法/16-图算法系列之计算图中最短路径.md","filePath":"article/pamphlet/algorithms/卧学算法/16-图算法系列之计算图中最短路径.md","lastUpdated":1723429417000}'),v={name:"article/pamphlet/algorithms/卧学算法/16-图算法系列之计算图中最短路径.md"},k=e("h1",{id:"图算法系列之计算图中最短路径",tabindex:"-1"},[g("图算法系列之计算图中最短路径 "),e("a",{class:"header-anchor",href:"#图算法系列之计算图中最短路径","aria-label":'Permalink to "图算法系列之计算图中最短路径"'},"​")],-1),y=u(`<h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>在前面两篇中我们通过深度优先搜索可以从图中找出一条通过顶点v到顶点w的路径，但是深度优先搜索与顶点的输入有很大的关系，找出来的路径也不一定是最短的，通常情况下我们很多时候需要找出图中的最短路径，比如：地图功能。这里我们就需要使用到广度优先搜索算法</p><h2 id="广度优先搜索" tabindex="-1">广度优先搜索 <a class="header-anchor" href="#广度优先搜索" aria-label="Permalink to &quot;广度优先搜索&quot;">​</a></h2><p>依然使用之前定义的寻找路径的API</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>public class Paths {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>以下图为列，来看看广度优先搜索的运行轨迹</p><p><img src="https://raw.githubusercontent.com/silently9527/images/main/0965db8ae1cd4b84ab7453e31c768db1%7Etplv-k3u1fbpfcp-zoom-1.image" alt=""></p><p><img src="https://raw.githubusercontent.com/silently9527/images/main/e8c5b8f000754f0f8bb3027dc531b2c0%7Etplv-k3u1fbpfcp-zoom-1.image" alt=""></p><p>单元测试的代码：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>@Test</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,26);function _(s,f,S,q,T,w){const l=i,t=r("ClientOnly");return p(),o("div",null,[k,h(t,null,{default:d(()=>{var a,n;return[(((a=s.$frontmatter)==null?void 0:a.aside)??!0)&&(((n=s.$frontmatter)==null?void 0:n.showArticleMetadata)??!0)?(p(),m(l,{key:0,article:s.$frontmatter},null,8,["article"])):b("",!0)]}),_:1}),y])}const I=c(v,[["render",_]]);export{x as __pageData,I as default};
