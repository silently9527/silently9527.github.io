import{_ as s,c as n,o as a,aa as e}from"./chunks/framework.d_Ke7vMG.js";const v=JSON.parse('{"title":"09 JSP视图InternalResourceView、RedirectView","description":"","frontmatter":{"title":"09 JSP视图InternalResourceView、RedirectView","author":"Herman","updateTime":"2021-08-14 13:41","desc":"深入解析SpringMVC核心原理：从手写简易版MVC框架开始(SmartMvc)","categories":"MyProjects","tags":"SpringMvc/MVC","outline":"deep"},"headers":[],"relativePath":"Notes/No1MyProjects/SmartMvc/09 View - JSP视图InternalResourceView、RedirectView-09view-jsp视图internalresourceviewredirectview.md","filePath":"Notes/No1MyProjects/SmartMvc/09 View - JSP视图InternalResourceView、RedirectView-09view-jsp视图internalresourceviewredirectview.md","lastUpdated":1723563552000}'),p={name:"Notes/No1MyProjects/SmartMvc/09 View - JSP视图InternalResourceView、RedirectView-09view-jsp视图internalresourceviewredirectview.md"},t=e(`<p>上一篇我们结束了<code>HandlerAdapter</code>各个组件的开发任务，本篇我们将开始研发视图的渲染；先看看类图</p><p><img src="https://raw.githubusercontent.com/silently9527/images/main/71c3c04a7b9941e6970489ac1fa3c0ab%7Etplv-k3u1fbpfcp-watermark.image" alt=""></p><p>本篇我们先完成jsp视图的渲染以及重定向视图的渲染；在整个项目开发完成之后，我们再通过自定义视图的方式开发Excel视图和JSON视图。</p><h4 id="_11-1-开发步骤讲解" tabindex="-1">11.1 开发步骤讲解 <a class="header-anchor" href="#_11-1-开发步骤讲解" aria-label="Permalink to &quot;11.1 开发步骤讲解&quot;">​</a></h4><blockquote><p>本节源代码的分支：view</p></blockquote><h5 id="view" tabindex="-1">View <a class="header-anchor" href="#view" aria-label="Permalink to &quot;View&quot;">​</a></h5><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public interface View {</span></span>
