import{_ as n,c as a,o as s,aa as e}from"./chunks/framework.d_Ke7vMG.js";const m=JSON.parse('{"title":"08 HandlerAdapter实现RequestMappingHandlerAdapter","description":"","frontmatter":{"title":"08 HandlerAdapter实现RequestMappingHandlerAdapter","author":"Herman","updateTime":"2021-08-14 13:41","desc":"深入解析SpringMVC核心原理：从手写简易版MVC框架开始(SmartMvc)","categories":"MyProjects","tags":"SpringMvc/MVC","outline":"deep"},"headers":[],"relativePath":"Notes/No1MyProjects/SmartMvc/08 HandlerAdapter - 实现RequestMappingHandlerAdapter-08handleradapter-实现requestmappinghandleradapter.md","filePath":"Notes/No1MyProjects/SmartMvc/08 HandlerAdapter - 实现RequestMappingHandlerAdapter-08handleradapter-实现requestmappinghandleradapter.md","lastUpdated":1723563552000}'),p={name:"Notes/No1MyProjects/SmartMvc/08 HandlerAdapter - 实现RequestMappingHandlerAdapter-08handleradapter-实现requestmappinghandleradapter.md"},l=e(`<p>本篇我们来完成<code>HandlerAdapter</code>的实现类<code>RequestMappingHandlerAdapter</code>，这也是<code>HandlerAdpater</code>的最后一节。先看看类图</p><p><img src="https://raw.githubusercontent.com/silently9527/images/main/1181981758-5fcf8588e5f60_articlex" alt=""></p><p><code>RequestMappingHandlerAdapter</code>本身在SpringMVC中占有重要的地位，虽然它只是<code>HandlerAdapter</code>的一种实现，但是它是使用最多的一个实现类，主要用于将某个请求适配给<code>@RequestMapping</code>类型的Handler处理</p><h4 id="_10-1-开发步骤讲解" tabindex="-1">10.1 开发步骤讲解 <a class="header-anchor" href="#_10-1-开发步骤讲解" aria-label="Permalink to &quot;10.1 开发步骤讲解&quot;">​</a></h4><blockquote><p>本节源代码的分支：handlerAdapter-requestMappingHandlerAdapter</p></blockquote><h5 id="handleradapter" tabindex="-1">HandlerAdapter <a class="header-anchor" href="#handleradapter" aria-label="Permalink to &quot;HandlerAdapter&quot;">​</a></h5><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public interface HandlerAdapter {</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>输出的结果如下：</p><p><img src="https://raw.githubusercontent.com/silently9527/images/main/1016234010-5fcf8c48aea95_articlex" alt=""></p><h4 id="_10-3-总结" tabindex="-1">10.3 总结 <a class="header-anchor" href="#_10-3-总结" aria-label="Permalink to &quot;10.3 总结&quot;">​</a></h4><p>本节通过开发<code>RequestMappingHandlerAdapter</code>，把我们之前开发的多个组件都组合起来了，并且能够正确的工作。</p><h4 id="_10-4-延展" tabindex="-1">10.4 延展 <a class="header-anchor" href="#_10-4-延展" aria-label="Permalink to &quot;10.4 延展&quot;">​</a></h4><p>SpringMVC中<code>HandlerAdapter</code>有多个实现类，都有不同的使用方式，而<code>RequestMappingHandlerAdapter</code>是使用最多的一个，有兴趣的同学可以看看其他的实现类</p>`,26),t=[l];function r(i,d,o,c,u,h){return s(),a("div",null,t)}const g=n(p,[["render",r]]);export{m as __pageData,g as default};
