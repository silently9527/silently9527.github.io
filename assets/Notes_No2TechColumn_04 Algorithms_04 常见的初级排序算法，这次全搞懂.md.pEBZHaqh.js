import{_ as a,c as s,o as n,aa as p}from"./chunks/framework.DOnJscRE.js";const u=JSON.parse('{"title":"04 常见的初级排序算法","description":"","frontmatter":{"title":"04 常见的初级排序算法","author":"Herman","updateTime":"2024-07-16 21:34","desc":"常见的初级排序算法，这次全搞懂","categories":"算法","tags":"数据结构/排序算法","outline":"deep"},"headers":[],"relativePath":"Notes/No2TechColumn/04 Algorithms/04 常见的初级排序算法，这次全搞懂.md","filePath":"Notes/No2TechColumn/04 Algorithms/04 常见的初级排序算法，这次全搞懂.md","lastUpdated":1724595807000}'),l={name:"Notes/No2TechColumn/04 Algorithms/04 常见的初级排序算法，这次全搞懂.md"},e=p(`<h1 id="常见的初级排序算法-这次全搞懂" tabindex="-1">常见的初级排序算法，这次全搞懂 <a class="header-anchor" href="#常见的初级排序算法-这次全搞懂" aria-label="Permalink to &quot;常见的初级排序算法，这次全搞懂&quot;">​</a></h1><h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>相信所有的程序员刚开始接触到的算法都会是排序算法，因为排序在对数据处理和计算有这重要的地位，排序算法往往是其他算法的基础；本文我们就先从初级排序算法开始学习算法。</p><h2 id="排序算法的模板" tabindex="-1">排序算法的模板 <a class="header-anchor" href="#排序算法的模板" aria-label="Permalink to &quot;排序算法的模板&quot;">​</a></h2><p>在开始之前我们先定义一个排序算法通用的模板，在后面的排序算法都会实现这个模板</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public interface SortTemplate {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre></div><p>假如输入的数组是有序的，我们会发现选择排序运行的时候和未排序的时间一样长！</p><p>对于N个元素的数组，使用<strong>选择排序的时间复杂度是O(n²)</strong></p><p>选择排序的是<strong>数据移动最少</strong>的，交换的次数与数组的大小是线性关系，N个元素的数组需要N次交换</p><h2 id="冒泡排序" tabindex="-1">冒泡排序 <a class="header-anchor" href="#冒泡排序" aria-label="Permalink to &quot;冒泡排序&quot;">​</a></h2><p>算法实现的思路：</p><ul><li>比较相邻的两个元素，如果前一个比后一个大，那么就交换两个元素的位置</li><li>对每一组相邻的元素执行同样的操作，直到最后一个元素，操作完成之后就可以排定一个最大的元素</li><li>如此往复，直到数组中所有的元素都有序</li></ul><p><img src="https://cdn.jsdelivr.net/gh/silently9527/images/baea01e2fb3648dc9e0fe419e0c9078d%7Etplv-k3u1fbpfcp-zoom-1.image" alt=""></p><p>代码实现：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class BubbleSort implements SortTemplate {</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    @Override</span></span>
<span class="line"><span>    public void sort(Comparable[] array) {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre></div><p>对于N个元素的数组，使用<strong>冒泡排序的时间复杂度是O(n²)</strong></p><h2 id="插入排序" tabindex="-1">插入排序 <a class="header-anchor" href="#插入排序" aria-label="Permalink to &quot;插入排序&quot;">​</a></h2><p>想象我们在玩扑克牌时，整理扑克牌都是把每一张插入到左边已经排好序的牌中适当的位置。插入排序的思路类似</p><p>算法实现的思路：</p><ul><li>初始默认第一个元素就是有序的，当前索引的位置从0开始</li><li>先后移动当前索引的位置，当前索引位置左边的元素是有序的，从后往前开始扫码与当前索引位置元素进行比较</li><li>当确定当前索引位置上的元素在左边有序适合的位置之后，插入到该位置上</li><li>如果当确定当前索引位置上的元素大于了已排序的最后一个元素，那么当前索引位置直接往后移动</li><li>如此反复，直到所有元素有序</li></ul><p><img src="https://cdn.jsdelivr.net/gh/silently9527/images/613c54d5f1c440bcab8be545854a80cd%7Etplv-k3u1fbpfcp-zoom-1.image" alt=""></p><p>代码实现：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class InsertionSort implements SortTemplate {</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    @Override</span></span>
<span class="line"><span>    public void sort(Comparable[] array) {</span></span>
<span class="line"><span>        int length = array.length;</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre></div>`,41),i=[e];function t(c,r,o,h,d,g){return n(),s("div",null,i)}const b=a(l,[["render",t]]);export{u as __pageData,b as default};
