...
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="自顶向下的归并排序" tabindex="-1">自顶向下的归并排序 <a class="header-anchor" href="#自顶向下的归并排序" aria-label="Permalink to &quot;自顶向下的归并排序&quot;">​</a></h2><p>基于分而治之的思想，大的数组排序，先递归拆分成小的数组，保证小的数组有序再归并，直到整个数组有序，这个操作就是自顶向下的归并排序</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class MergeSort implements SortTemplate {</span></span>
<span class="line"><span>    private Comparable[] aux;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    @Override</span></span>
<span class="line"><span>    public void sort(Comparable[] array) {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre></div><p>以上代码是标准的递归归并排序操作，但是经过仔细思考之后，该算法还有可以优化的地方</p><ol><li><strong>测试数组是否已经有序</strong>；如果a[mid]&lt;=a[mid+1]，那么我们就可以跳过merge方法，减少merge操作；修复之后的doSort方法</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>private void doSort(Comparable[] array, int lo, int hi) {</span></span>
<span class="line"><span>    if (lo &gt;= hi) {</span></span>
<span class="line"><span>        return;</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>    int mid = (hi - lo) / 2 + lo;</span></span>
...
<span class="line"><span>        merge(array, lo, mid, hi);</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><ol start="2"><li><strong>对于小规模的数组可以是用插入排序</strong>；对于小规模的数组使用归并排序会增加递归调用栈，所以我们可以考虑使用插入排序来处理子数组的排序</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>private void doSort(Comparable[] array, int lo, int hi) {</span></span>
<span class="line"><span>    if (lo &gt;= hi) {</span></span>
<span class="line"><span>        return;</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>        }</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><ol start="3"><li><strong>节省复制元素到辅助数组的时间</strong>；要实现该操作较麻烦，需要在每一层递归的时候交换输入数据和输出数组的角色；修改之后的完整代码如下：</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class MergeSort implements SortTemplate {</span></span>
<span class="line"><span>    private Comparable[] aux;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    @Override</span></span>
<span class="line"><span>    public void sort(Comparable[] array) {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre></div><p>每一层递归操作都会让子数组有序，但是子数组可能是aux[lo..hi]也有可能是a[lo..hi]；由于第一次调用doSort传入的是src=aux，dest=array，所以递归最后的结果一定是输入到了array中，保证了array整体排序完成</p><h2 id="自底向上的归并排序" tabindex="-1">自底向上的归并排序 <a class="header-anchor" href="#自底向上的归并排序" aria-label="Permalink to &quot;自底向上的归并排序&quot;">​</a></h2><p>实现归并算法还有另一种思路，就是先归并哪些小的数组，然后再成对归并得到子数组，直到整个数组有序</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class MergeSort implements SortTemplate {</span></span>
<span class="line"><span>    private Comparable[] aux;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    @Override</span></span>
<span class="line"><span>    public void sort(Comparable[] array) {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span></span></span></code></pre></div>`,27),e=[i];function t(c,r,o,d,h,m){return n(),a("div",null,e)}const b=s(l,[["render",t]]);export{g as __pageData,b as default};
