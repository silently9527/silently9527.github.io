...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>直接运行之前我们开发好的<code>DispatcherServletTest</code>中的两个单元测试方法，执行结果如下：</p><p><img src="https://cdn.jsdelivr.net/gh/silently9527/images/bdaf2c983b874466a62166dd506346b9%7Etplv-k3u1fbpfcp-watermark.image" alt=""></p><h4 id="_15-3-总结" tabindex="-1">15.3 总结 <a class="header-anchor" href="#_15-3-总结" aria-label="Permalink to &quot;15.3 总结&quot;">​</a></h4><p>本篇实现了SmartMVC通过注解<code>@EnableWebMvc</code>驱动整个框架的配置，这个也是SpringMVC的实现方式，同时也展示了SPI的设计思路</p><h4 id="_15-4-延展" tabindex="-1">15.4 延展 <a class="header-anchor" href="#_15-4-延展" aria-label="Permalink to &quot;15.4 延展&quot;">​</a></h4><p>可以对比查看SpringMVC中提供的<code>WebMvcConfigurationSupport</code>，熟悉提供了哪些扩展点，工作中可以使用</p>`,37),i=[l];function t(r,c,o,d,g,u){return a(),n("div",null,i)}const b=s(p,[["render",t]]);export{h as __pageData,b as default};
