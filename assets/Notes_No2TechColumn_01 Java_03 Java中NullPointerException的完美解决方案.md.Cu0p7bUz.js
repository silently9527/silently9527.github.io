...
<span class="line"><span>    }</span></span>
<span class="line"><span>    return person.getPhone().getProducer().getName();</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>这里我已经试图在减少代码的层级，如果使用的是<code>if-else</code>，代码的层级会更深，代码可读性下降。</p><hr><h4 id="optional的简单介绍" tabindex="-1">Optional的简单介绍 <a class="header-anchor" href="#optional的简单介绍" aria-label="Permalink to &quot;Optional的简单介绍&quot;">​</a></h4><p>吐槽了那么多现状的不好，现在可以祭出我们的解决方案了 <code>Optional</code>；千呼万唤始出来，犹抱琵琶半遮面；那<code>Optional</code>到底是个什么东西，我们一起来逐步解开它的面纱。</p><p><img src="https://raw.githubusercontent.com/silently9527/images/main/1883051154-5fb2773078853_articlex" alt=""></p><p><code>Optional</code>本身只是对对象的简单包装，如果对象为空，那么会构建一个空的<code>Optional</code>；这样一来<code>Optional</code>就包含了存在和不存在两个情况, 接下来可以看下上面的例子改过之后</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class Person {</span></span>
