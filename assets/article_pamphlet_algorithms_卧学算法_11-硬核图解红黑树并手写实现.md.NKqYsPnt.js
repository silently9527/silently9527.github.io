...
<span class="line"><span>}</span></span></code></pre></div><p>重新指定两个节点的左右子树的链接，并且修改节点的颜色。其次是计算每个子树所包含的节点个数，计算的方式与上一篇中二叉树的size实现类似，这里就不重复叙述，参考《基于二叉树实现Map》</p><ul><li>右旋</li></ul><p><img src="https://raw.githubusercontent.com/silently9527/images/main/0b994cd445114349b0328224e4ca8f61~tplv-k3u1fbpfcp-zoom-1.image" alt=""></p><p>右旋代码实现如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>protected Node rotateRight(Node h) {</span></span>
