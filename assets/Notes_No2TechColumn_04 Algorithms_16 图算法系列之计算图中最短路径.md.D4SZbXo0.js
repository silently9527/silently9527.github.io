import{_ as s,c as n,o as a,aa as p}from"./chunks/framework.d_Ke7vMG.js";const m=JSON.parse('{"title":"17 图算法之计算图中最短路径","description":"","frontmatter":{"title":"17 图算法之计算图中最短路径","author":"Herman","updateTime":"2024-07-16 21:34","desc":"图算法系列之计算图中最短路径","categories":"算法","tags":"数据结构/广度优先搜索/图算法","outline":"deep"},"headers":[],"relativePath":"Notes/No2TechColumn/04 Algorithms/16 图算法系列之计算图中最短路径.md","filePath":"Notes/No2TechColumn/04 Algorithms/16 图算法系列之计算图中最短路径.md","lastUpdated":1724592993000}'),e={name:"Notes/No2TechColumn/04 Algorithms/16 图算法系列之计算图中最短路径.md"},l=p(`<h1 id="图算法系列之计算图中最短路径" tabindex="-1">图算法系列之计算图中最短路径 <a class="header-anchor" href="#图算法系列之计算图中最短路径" aria-label="Permalink to &quot;图算法系列之计算图中最短路径&quot;">​</a></h1><h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>在前面两篇中我们通过深度优先搜索可以从图中找出一条通过顶点v到顶点w的路径，但是深度优先搜索与顶点的输入有很大的关系，找出来的路径也不一定是最短的，通常情况下我们很多时候需要找出图中的最短路径，比如：地图功能。这里我们就需要使用到广度优先搜索算法</p><h2 id="广度优先搜索" tabindex="-1">广度优先搜索 <a class="header-anchor" href="#广度优先搜索" aria-label="Permalink to &quot;广度优先搜索&quot;">​</a></h2><p>依然使用之前定义的寻找路径的API</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class Paths {</span></span>
