import{_ as t}from"./chunks/ArticleMetadata.IwlMn1X8.js";import{_ as o,D as c,o as p,c as r,I as d,w as h,k as e,a as g,R as u,b as m,e as f}from"./chunks/framework.412fhWlr.js";import"./chunks/md5.6OGdLw3O.js";const C=JSON.parse('{"title":"硬核图解红黑树并手写实现","description":"","frontmatter":{"title":"硬核图解红黑树并手写实现","author":"Herman","date":"2021/08/14 13:58","categories":["算法"],"tags":["数据结构","红黑树"]},"headers":[],"relativePath":"article/pamphlet/algorithms/基础算法/硬核图解红黑树并手写实现.md","filePath":"article/pamphlet/algorithms/基础算法/硬核图解红黑树并手写实现.md","lastUpdated":1723377986000}'),v={name:"article/pamphlet/algorithms/基础算法/硬核图解红黑树并手写实现.md"},b=e("h1",{id:"硬核图解红黑树并手写实现",tabindex:"-1"},[g("硬核图解红黑树并手写实现 "),e("a",{class:"header-anchor",href:"#硬核图解红黑树并手写实现","aria-label":'Permalink to "硬核图解红黑树并手写实现"'},"​")],-1),k=u(`<h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>在上一篇中我们通过二叉树作为了Map的实现，最后也分析了该版本的时间复杂度以及最糟糕的情况；本篇我们将会使用红黑树来实现Map，改善上一篇中二叉树版本的不足；对于Map接口的定义以及已经实现的公用方法将不会重复叙述，比如二叉树的查找方法（get）；不了解的兄弟请查看上一篇《基于二叉树实现Map》</p><p>红黑树算是数据结构中比较有难度的知识点，虽然在实际的业务开发工作中使用的不多，但是这是面试官最喜欢问的知识点。</p><p>我在之前也看过很多关于红黑树的文章，但是很多都是从红黑树的性质来讲红黑树，根本未从红黑树的理论模型出发讲红黑树，所以造成红黑树比较难理解。</p><p>理解并掌握红黑树还是有必要的，Java中的HashMap当链表的节点数超过了8个就会把链表转换成红黑树；TreeMap底层也是用的是红黑树；</p><p>红黑树于我们上一篇讨论的二叉树相比，红黑树几乎是完美平衡的，并且能够保证操作的运行时间都是对数级别</p><p>在学习红黑树之前，我们先来看看红黑树的性质，针对每一条性质我们都需要问一个Why，带着问题去学习红黑树；如果我们搞懂了这些问题，那么就理解了红黑树本质，当然与实现还有一些距离。</p><ul><li>性质1. 结点是红色或黑色。（why：为什么节点要区分颜色，红色节点的作用是什么？）</li><li>性质2. 根结点是黑色。（why：为什么根节点必须是黑色）</li><li>性质3. 所有叶子都是黑色。（why）</li><li>性质4. 从每个叶子到根的所有路径上不能有两个连续的红色结点。(why)</li><li>性质5. 从任一节结点其每个叶子的所有路径都包含相同数目的黑色结点。(why)</li><li>性质6. 每次新插入的节点都必须是红色（why）</li></ul><h2 id="平衡查找树" tabindex="-1">平衡查找树 <a class="header-anchor" href="#平衡查找树" aria-label="Permalink to &quot;平衡查找树&quot;">​</a></h2><p>红黑树是近似平衡的二叉树，红黑树对应的理论模型可以是2-3树，也可以是2-3-4树，所以在学习红黑树之前，我们需要先了解2-3树和2-3-4树；</p><p>红黑树与2-3树、2-3-4树的关系就好比接口与实现类的关系；2-3树与2-3-4树是接口，而红黑树是基于接口的实现</p><p>2-3树、2-3-4树都是B树的特列情况</p><h3 id="_2-3树" tabindex="-1">2-3树 <a class="header-anchor" href="#_2-3树" aria-label="Permalink to &quot;2-3树&quot;">​</a></h3><p>为了保证树的绝对平衡，允许树中的节点保存多个键值，在2-3树中可以出现一个节点存在一个键值两条链接，也允许同一个节点包含最多两个键三条链接；</p><p>2-3树如下图：</p><p><img src="https://tva1.sinaimg.cn/large/008eGmZEgy1gp5rblk9upj30ic0ai3yi.jpg" alt=""></p><h4 id="查找" tabindex="-1">查找 <a class="header-anchor" href="#查找" aria-label="Permalink to &quot;查找&quot;">​</a></h4><p>2-3树的查找过程与二叉树类似，查找键与节点中的键比较，如果遇到与查找键相等的节点，查找命中；否则继续去对应的子树中去查找，如果遇到空的链接表示查找未命中。</p><p><img src="https://tva1.sinaimg.cn/large/008eGmZEgy1gp6j4ld4yzj31ke0ds0tc.jpg" alt=""></p><h4 id="插入" tabindex="-1">插入 <a class="header-anchor" href="#插入" aria-label="Permalink to &quot;插入&quot;">​</a></h4><ul><li>向单键key的节点中插入：当前节点只有一个key, 直接在当前节点新增一个key</li></ul><p><img src="https://tva1.sinaimg.cn/large/008eGmZEgy1gp6j63dqmnj30gk05u3yc.jpg" alt=""></p><ul><li>向双键key的节点中插入：先插入新的key到当前节点，如果当前节点大于了两个key</li></ul><p><img src="https://tva1.sinaimg.cn/large/008eGmZEgy1gp6jakacsbj30xa07s749.jpg" alt=""></p><ul><li>向双键key的节点中插入，并且父节点也是双键</li></ul><p><img src="https://tva1.sinaimg.cn/large/008eGmZEgy1gp6k895vu6j31j80bwjrv.jpg" alt=""></p><p>通过上面的三种情况的演示，我们发现2-3树和标准的二叉树的生长是不同的，二叉树的生长是由上向下生长的，而2-3树的生长是由下向上的。</p><p>在上一篇的二叉树中，我们发现最糟糕的情况是插入的节点有序，导致二叉树退化成了链表，性能下降，我们使用2-3树顺序插入看看如何，例如顺序插入1，2，3，4，5，6，7</p><p><img src="https://tva1.sinaimg.cn/large/008eGmZEgy1gp6kpyv7wmj31ky0j40tj.jpg" alt=""></p><p><strong>由此我们可以看出在最坏的情况下2-3树依然完美平衡的，有比较好的性能。但是这是理论，与真正的实现还是有一段距离</strong></p><h3 id="基于2-3树实现的左倾红黑树" tabindex="-1">基于2-3树实现的左倾红黑树 <a class="header-anchor" href="#基于2-3树实现的左倾红黑树" aria-label="Permalink to &quot;基于2-3树实现的左倾红黑树&quot;">​</a></h3><p>了解了红黑树的理论模型2-3树之后，那么就可以基于2-3树来实现我们的红黑树。</p><p>由于2-3树中存在着双键的节点，由于我们需要在二叉树中表示出双键的节点，所以我们需要在节点中添加一个颜色的属性color，如果节点是红色，那么表示当前节点和父节点共同组成了2-3树中的双键节点。</p><p>对上一篇中二叉树的节点做一些修改，代码如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>class Node implements TreeNode {</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><h4 id="旋转" tabindex="-1">旋转 <a class="header-anchor" href="#旋转" aria-label="Permalink to &quot;旋转&quot;">​</a></h4><p>在实现红黑树的插入或者删除操作可能会出现红色节点在右边或者两个连续的红色节点，在出现这些情况的时候我们需要通过旋转操作来完成修复。</p><p><strong>由于旋转操作完成之后需要修改父节点的链接，所以我们定义的旋转方法需要返回旋转之后的节点来重置父节点的链接</strong></p><ul><li>左旋</li></ul><p><img src="https://tva1.sinaimg.cn/large/008eGmZEgy1gp6qaptzu1j30w40cg3yn.jpg" alt=""></p><p>左旋代码实现如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>protected Node rotateLeft(Node h) {</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>重新指定两个节点的左右子树的链接，并且修改节点的颜色。其次是计算每个子树所包含的节点个数，计算的方式与上一篇中二叉树的size实现类似，这里就不重复叙述，参考《基于二叉树实现Map》</p><ul><li>右旋</li></ul><p><img src="https://tva1.sinaimg.cn/large/008eGmZEgy1gp6uufn6hcj310i0bwdg0.jpg" alt=""></p><p>右旋代码实现如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>protected Node rotateRight(Node h) {</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><h4 id="插入-1" tabindex="-1">插入 <a class="header-anchor" href="#插入-1" aria-label="Permalink to &quot;插入&quot;">​</a></h4><h5 id="向单键节点插入" tabindex="-1">向单键节点插入 <a class="header-anchor" href="#向单键节点插入" aria-label="Permalink to &quot;向单键节点插入&quot;">​</a></h5><ol><li>如果插入的键小于当前节点的键值，那么直接新增一个红色左节点</li></ol><p><img src="https://tva1.sinaimg.cn/large/008eGmZEgy1gp6x6b3sfgj30hk08cdfp.jpg" alt=""></p><ol start="2"><li>如果插入的键大于当前节点的键值，那么插入一个红色的右节点，由于只允许左边出现红色节点，所以我们需要进行左旋一次</li></ol><p><img src="https://tva1.sinaimg.cn/large/008eGmZEgy1gp6x8bklwoj30oo094t8p.jpg" alt=""></p><h5 id="向双键节点中插入" tabindex="-1">向双键节点中插入 <a class="header-anchor" href="#向双键节点中插入" aria-label="Permalink to &quot;向双键节点中插入&quot;">​</a></h5><ol><li>向双键节点中插入新的键有三种情况，我们先来看最简单的情况，插入的键值最大，插入之后只需要变化颜色即可，变化过程如下图</li></ol><p><img src="https://tva1.sinaimg.cn/large/008eGmZEgy1gp7g5mdf66j30x0094dfx.jpg" alt=""></p><ol start="2"><li>第二种情况是插入的键值最小，插入之后造成了两个红色节点相连，所以需要进行右旋，然后在变色</li></ol><p><img src="https://tva1.sinaimg.cn/large/008eGmZEgy1gp7ga5zfejj319o08qglt.jpg" alt=""></p><ol start="3"><li>第三种情况插入的键值在原来两键之间，需要先进行左旋，再右旋，最后在变色</li></ol><p><img src="https://tva1.sinaimg.cn/large/008eGmZEgy1gp7gevsh2kj31gq08w0t4.jpg" alt=""></p><p>根据以上各种情况的分析，我们可以总结出统一的变化规律：</p><ul><li>若右子节点是红色，左子节点是黑树，那么就进行左旋</li><li>若左子节点是红色且他的左子节点也是红色，那么就进行右旋</li><li>若左右子节点都是红色，那么就进行颜色转换</li></ul><p>图形变化如下：</p><p><img src="https://tva1.sinaimg.cn/large/008eGmZEgy1gp7jrul060j31eu0lyt9c.jpg" alt=""></p><p>经过上面的分析之后我们现在可以来代码实现红黑树的插入操作</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>@Override</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>在正式实现删除操作之前，我们先来讨论下红黑树删除最小值和最大值的情况，最后实现的删除操作也会使用到删除最小值和删除最大值</p><h5 id="删除最小值" tabindex="-1">删除最小值 <a class="header-anchor" href="#删除最小值" aria-label="Permalink to &quot;删除最小值&quot;">​</a></h5><p>二叉树删除最小值就是一直沿着树的左子树中查找，直到遇到一个节点的左子树为null，那么就删除该节点</p><p>红黑树的删除最小值类似，但是我们需要保证待删除的节点是一个双键的节点，所以在在递归到每个节点是都需要保住当前节点是双键节点，那么在最后找到的最小值就一定会在一个双键节点中（因为递归时已经保住的父节点是双键节点）。</p><p>那么如果保证当前递归节点是一个双键节点呢？这里就会有3中情况:</p><ul><li>当前节点的左子节点是一个双键节点，直接删除</li></ul><p><img src="https://tva1.sinaimg.cn/large/008eGmZEgy1gp82u62kg4j30n206ggli.jpg" alt=""></p><ul><li>当前节点的左子节点是一个单键节点，但他的兄弟是一个双键节点，那么通过旋转移动一个节点到左子节点形成双键节点之后，再执行删除操作</li></ul><p><img src="https://tva1.sinaimg.cn/large/008eGmZEgy1gp82w2a6wbj31j208yt92.jpg" alt=""></p><ul><li>当前节点的左子节点和右子节点都是单键节点，那么通过变色与父节点共同形成三键节点之后，再执行删除</li></ul><p><img src="https://tva1.sinaimg.cn/large/008eGmZEgy1gp82xz602hj31fa07yjrk.jpg" alt=""></p><p>以上是红黑树删除最小值会遇到的所有情况，针对最后两种情况，为了代码的实现简单，我们考虑把这两种情况进行合并；</p><p>先把初始化根节点为红色，再进行变色，然后判断是否node.right.left是红色，如果是就进行旋转操作 <img src="https://tva1.sinaimg.cn/large/008eGmZEgy1gp835qpajdj31c40lidgs.jpg" alt=""></p><p>删除最小值的代码实现如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>private Node moveToRedLeft(Node h) {</span></span>
...
<span class="line"><span>    return h;</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>在删除掉最小值之后，我们需要重新修复红黑树，因为之前我们的操作可能会导致3键节点的存在，删除之后我们需要重新分解3建节点；上面代码中的balance就是重新修复红黑树。</p><h5 id="删除最大值" tabindex="-1">删除最大值 <a class="header-anchor" href="#删除最大值" aria-label="Permalink to &quot;删除最大值&quot;">​</a></h5><p>删除最大值思路和删除最小值的思路类似，这里就不详细叙述了，直接上图</p><p><img src="https://tva1.sinaimg.cn/large/008eGmZEgy1gp8o0jzhtfj31e00lut9g.jpg" alt=""></p><p>删除最大值需要从左节点中借一个节点，代码实现如下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>@Override</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>顺序打印出node的执行的结果：</p><p><img src="https://tva1.sinaimg.cn/large/008eGmZEgy1gp8p5kl0ymj31aw0fm3zc.jpg" alt=""></p><p>删除之前的红黑树</p><p><img src="https://tva1.sinaimg.cn/large/008eGmZEgy1gp8p7u4zj5j308w07u3ya.jpg" alt=""></p><p>删除之后的红黑树</p><p><img src="https://tva1.sinaimg.cn/large/008eGmZEgy1gp8p8a6v7oj309w08cwe9.jpg" alt=""></p><h2 id="总结" tabindex="-1">总结 <a class="header-anchor" href="#总结" aria-label="Permalink to &quot;总结&quot;">​</a></h2><p>本篇主要讨论的是基于2-3树实现的红黑树版本，理解并掌握了本篇内容也就掌握了红黑树，<strong>面试时根本不虚</strong>。</p><p>为了加深对红黑树的理解，大家可以自行基于2-3-4树去实现红黑树，对比两种红黑树的版本差异，可以参考我的git仓库中的代码</p><hr><p>文中所有源码已放入到了github仓库: <a href="https://github.com/silently9527/JavaCore" target="_blank" rel="noreferrer">https://github.com/silently9527/JavaCore</a></p><blockquote><p>给出一个红黑树网站演示，该网站实现红黑树的方式与本篇我们实现的方式不同，大家可以参考下：<a href="https://www.cs.usfca.edu/~galles/visualization/RedBlack.html" target="_blank" rel="noreferrer">https://www.cs.usfca.edu/~galles/visualization/RedBlack.html</a></p></blockquote>`,143);function y(s,q,j,R,N,x){const l=t,i=c("ClientOnly");return p(),r("div",null,[b,d(i,null,{default:h(()=>{var a,n;return[(((a=s.$frontmatter)==null?void 0:a.aside)??!0)&&(((n=s.$frontmatter)==null?void 0:n.showArticleMetadata)??!0)?(p(),m(l,{key:0,article:s.$frontmatter},null,8,["article"])):f("",!0)]}),_:1}),k])}const B=o(v,[["render",y]]);export{C as __pageData,B as default};
