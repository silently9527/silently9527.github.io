import{_ as n,o as s,c as a,R as p}from"./chunks/framework.412fhWlr.js";const m=JSON.parse('{"title":"基于二叉树实现Map","description":"","frontmatter":{"title":"基于二叉树实现Map","date":"2021-08-14T13:59:45.211Z","updated":"2021-08-15T11:59:29.841Z","url":"/?p=49","categories":"算法","tags":"数据结构 | 二叉树"},"headers":[],"relativePath":"article/pamphlet/algorithms/基础算法/基于二叉树实现Map.md","filePath":"article/pamphlet/algorithms/基础算法/基于二叉树实现Map.md","lastUpdated":1723371853000}'),e={name:"article/pamphlet/algorithms/基础算法/基于二叉树实现Map.md"},l=p(`<blockquote><p>程序员常用的IDEA插件：<a href="https://github.com/silently9527/ToolsetIdeaPlugin" target="_blank" rel="noreferrer">https://github.com/silently9527/ToolsetIdeaPlugin</a></p><p>微信公众号：贝塔学Java</p></blockquote><h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>在上一篇中我们基于数组和链表实现了Map的相关操作，但是对于数据量稍大的情况下，这两种实现方式效率都比较低，为了改进这个问题，本篇我们将来学习二叉树，并通过二叉树来实现上一篇中定义的Map结构</p><h2 id="二叉树简介" tabindex="-1">二叉树简介 <a class="header-anchor" href="#二叉树简介" aria-label="Permalink to &quot;二叉树简介&quot;">​</a></h2><p>虽然大家都知道二叉树是什么，但是为了保证文章的完整性，这里还是简单说说什么是二叉树</p><p>二叉树中每个节点都包含了两个指针指向自己的左子树和右子树。</p><p>二叉树的每个节点都包含了一个Key, 并且每个节点的Key都大于其左子树中的任意节点，小于右子树中的任意节点。</p><p><img src="https://tva1.sinaimg.cn/large/008eGmZEly1goqpo9fra0j30b106x74d.jpg" alt=""></p><p>节点的数据结构定义：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>class Node {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p><code>size</code> 记录当前节点所在子树的节点个数，计算方式：<code>size=左子树的个数 + 1 + 右子树的个数</code></p><h2 id="基于二叉树实现map" tabindex="-1">基于二叉树实现Map <a class="header-anchor" href="#基于二叉树实现map" aria-label="Permalink to &quot;基于二叉树实现Map&quot;">​</a></h2><p>在上一篇《基于数组或链表实现Map》中我们定义了Map的接口，本篇我们继续使用该map接口</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>public interface Map&lt;K, V&gt; {</span></span>
...
<span class="line"><span>    node.size = size(node.left) + 1 + size(node.right);</span></span>
<span class="line"><span>    return node;</span></span>
<span class="line"><span>}</span></span></code></pre></div><h4 id="删除" tabindex="-1">删除 <a class="header-anchor" href="#删除" aria-label="Permalink to &quot;删除&quot;">​</a></h4><p>我们可以通过类似的方式去删除只有一个子节点或者是没有子节点的节点；但是如果遇到需要删除有两个节点的节点应该怎么操作呢？</p><p>两种思路：用左子树的最大值替换待删除节点，然后删除掉左子树的最大值；或者是用右子树中的最小值替换待删除节点，然后删除右子树中的最小值</p><p>步骤：</p><ol><li>从该节点的左子树中取出最大值或者是从右子树中取出最小值</li><li>用最大值或者最小值替换当前的节点</li><li>调用删除最大值或者删除最小值</li></ol><p><img src="https://tva1.sinaimg.cn/large/008eGmZEly1goqrv987hcj30iu0tujyk.jpg" alt=""></p><p>代码实现</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>@Override</span></span>
