import{_ as s,c as n,o as a,aa as e}from"./chunks/framework.d_Ke7vMG.js";const g=JSON.parse('{"title":"11 DispatcherServlet","description":"","frontmatter":{"title":"11 DispatcherServlet","author":"Herman","updateTime":"2021-08-14 13:41","desc":"深入解析SpringMVC核心原理：从手写简易版MVC框架开始(SmartMvc)","categories":"MyProjects","tags":"SpringMvc/MVC","outline":"deep"},"headers":[],"relativePath":"Notes/No1MyProjects/02 SmartMvc/11 DispatcherServlet - 实现doDispatch完成请求逻辑.md","filePath":"Notes/No1MyProjects/02 SmartMvc/11 DispatcherServlet - 实现doDispatch完成请求逻辑.md","lastUpdated":1724593073000}'),p={name:"Notes/No1MyProjects/02 SmartMvc/11 DispatcherServlet - 实现doDispatch完成请求逻辑.md"},l=e(`<p>本篇我们将开始研发SpringMVC中核心组件DispatcherServlet</p><p><img src="https://cdn.jsdelivr.net/gh/silently9527/images/5a0276884f1b4a63bdee4fb9f3096607%7Etplv-k3u1fbpfcp-watermark.image" alt=""></p><h4 id="_13-1-开发步骤讲解" tabindex="-1">13.1 开发步骤讲解 <a class="header-anchor" href="#_13-1-开发步骤讲解" aria-label="Permalink to &quot;13.1 开发步骤讲解&quot;">​</a></h4><blockquote><p>本节源代码的分支：dispatcherServlet</p></blockquote><h5 id="dispatcherservlet" tabindex="-1">DispatcherServlet <a class="header-anchor" href="#dispatcherservlet" aria-label="Permalink to &quot;DispatcherServlet&quot;">​</a></h5><p><code>DispatcherServlet</code> 继承自 <code>HttpServlet</code> ，通过使用 Servlet API 对 HTTP 请求进行响应。其工作大致分为两部分：</p><ol><li>初始化部分，当Servlet在第一次初始化的时候会调用 init方法，在该方法里对诸如 handlerMapping，ViewResolver 等进行初始化，代码如下：</li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>@Override</span></span>
