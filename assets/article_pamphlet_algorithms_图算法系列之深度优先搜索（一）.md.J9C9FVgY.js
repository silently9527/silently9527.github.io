import{_ as s,o as a,c as n,R as p}from"./chunks/framework.412fhWlr.js";const u=JSON.parse('{"title":"图算法系列之深度优先搜索（一）","description":"","frontmatter":{"title":"图算法系列之深度优先搜索（一）","date":"2021-08-14T14:00:46.053Z","updated":"2021-08-15T11:58:16.768Z","url":"/?p=53","categories":"算法","tags":"图算法 | 深度优先搜索"},"headers":[],"relativePath":"article/pamphlet/algorithms/图算法系列之深度优先搜索（一）.md","filePath":"article/pamphlet/algorithms/图算法系列之深度优先搜索（一）.md","lastUpdated":1723370029000}'),e={name:"article/pamphlet/algorithms/图算法系列之深度优先搜索（一）.md"},l=p(`<h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>在上一篇中我们把图通过邻接表数组表示出来了，这个数据结构将会做我们实现图算法的基础，本篇我们将一起开始学习图算法的第一个搜索算法 - 深度优先搜索</p><h2 id="搜索api的定义" tabindex="-1">搜索API的定义 <a class="header-anchor" href="#搜索api的定义" aria-label="Permalink to &quot;搜索API的定义&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>public class Search {</span></span>
