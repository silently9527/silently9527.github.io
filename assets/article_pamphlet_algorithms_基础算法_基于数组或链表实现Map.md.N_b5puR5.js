...
<span class="line"><span>    size--;</span></span>
<span class="line"><span>}</span></span></code></pre></div><blockquote><p>基于数组实现的Map，虽然get方法采用的二分查找法，很快O(logN)，但是在处理大量数据的情况下效率依然很低，因为put方法还是太慢；下篇我们将基于二叉树来实现Map，继续改进提升效率</p></blockquote>`,31),i=[l];function t(c,o,d,r,u,h){return n(),a("div",null,i)}const v=s(e,[["render",t]]);export{g as __pageData,v as default};
