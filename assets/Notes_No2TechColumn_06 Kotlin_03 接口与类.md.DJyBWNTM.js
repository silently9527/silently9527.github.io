import{_ as a,c as s,o as n,aa as p}from"./chunks/framework.DOnJscRE.js";const v=JSON.parse('{"title":"03 接口与类","description":"","frontmatter":{"title":"03 接口与类","author":"Herman","updateTime":"2024-09-18 12:34","desc":"Kotlin 基础入门","categories":"Kotlin","tags":"Kotlin","outline":"deep"},"headers":[],"relativePath":"Notes/No2TechColumn/06 Kotlin/03 接口与类.md","filePath":"Notes/No2TechColumn/06 Kotlin/03 接口与类.md","lastUpdated":1761052119000}'),e={name:"Notes/No2TechColumn/06 Kotlin/03 接口与类.md"},l=p(`<h4 id="接口" tabindex="-1">接口 <a class="header-anchor" href="#接口" aria-label="Permalink to &quot;接口&quot;">​</a></h4><p>Kotlin接口定义依旧使用<code>interface</code></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>interface Animal {</span></span>
