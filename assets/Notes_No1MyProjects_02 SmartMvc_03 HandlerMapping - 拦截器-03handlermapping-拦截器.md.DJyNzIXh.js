...
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre></div><p>运行的结果：</p><p><img src="https://raw.githubusercontent.com/silently9527/images/main/2823792745-5fc36b8194b78_articlex" alt=""></p><h4 id="_4-3-本节小结" tabindex="-1">4.3 本节小结 <a class="header-anchor" href="#_4-3-本节小结" aria-label="Permalink to &quot;4.3 本节小结&quot;">​</a></h4><p>本节我们完成了拦截器相关逻辑的开发，如果有面试官问<code>HandlerInterceptor</code>中的<code>afterCompletion</code>方法在哪些情况下会执行，我们应该能回答了</p><h4 id="_4-4-延展" tabindex="-1">4.4 延展 <a class="header-anchor" href="#_4-4-延展" aria-label="Permalink to &quot;4.4 延展&quot;">​</a></h4><p>本节实现的拦截器和SpringMVC提供的拦截器有些许差别，功能也不如SpringMVC的强大，大家可以对比着看看，加深对SpringMVC拦截器的理解</p>`,29),l=[t];function r(i,c,o,d,u,h){return a(),s("div",null,l)}const b=n(e,[["render",r]]);export{g as __pageData,b as default};
