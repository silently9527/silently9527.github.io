import{_ as n,c as a,o as s,aa as e}from"./chunks/framework.d_Ke7vMG.js";const h=JSON.parse('{"title":"01 SmartMVC整体规划","description":"","frontmatter":{"title":"01 SmartMVC整体规划","author":"Herman","updateTime":"2021-08-14 13:41","desc":"深入解析SpringMVC核心原理：从手写简易版MVC框架开始(SmartMvc)","categories":"MyProjects","tags":"SpringMvc/MVC","outline":"deep"},"headers":[],"relativePath":"Notes/No1MyProjects/02 SmartMvc/01 SmartMVC整体规划-smartmvc整体规划.md","filePath":"Notes/No1MyProjects/02 SmartMvc/01 SmartMVC整体规划-smartmvc整体规划.md","lastUpdated":1723606122000}'),p={name:"Notes/No1MyProjects/02 SmartMvc/01 SmartMVC整体规划-smartmvc整体规划.md"},t=e(`<h4 id="ide、源码、依赖版本" tabindex="-1">IDE、源码、依赖版本 <a class="header-anchor" href="#ide、源码、依赖版本" aria-label="Permalink to &quot;IDE、源码、依赖版本&quot;">​</a></h4><ul><li>整个开发过程中我使用的IDE都是IDEA，可以根据读者自己习惯选择。当然我推荐是用IDEA</li><li>开发SmartMVC我们需要使用到Spring，我使用的版本<code>5.2.9</code></li><li>开发完成后SmartMVC的源码会放在码云仓库： <a href="https://note.youdao.com/" target="_blank" rel="noreferrer">https://gitee.com/silently9527/smart-mvc.git</a></li><li>JDK的版本1.8</li></ul><h4 id="开发过程中的约定" tabindex="-1">开发过程中的约定 <a class="header-anchor" href="#开发过程中的约定" aria-label="Permalink to &quot;开发过程中的约定&quot;">​</a></h4><ul><li>为了便于用户后期理解和使用SpringMVC，所以在SmartMVC中所有组件的名称都和SpringMVC的保持一致</li><li>为了让SpringMVC的核心流程更加的清晰，减少读者的干扰，我拿出了自己18米的砍刀大胆的砍掉了SpringMVC中很多细节流程，达到去枝干立主脑，让读者能够更加顺畅的理解整个流转的过程</li></ul><h4 id="_3-1-smartmvc总体架构" tabindex="-1">3.1 SmartMVC总体架构 <a class="header-anchor" href="#_3-1-smartmvc总体架构" aria-label="Permalink to &quot;3.1 SmartMVC总体架构&quot;">​</a></h4><p>在开始撸代码之前我们需要先设计好整个框架架构，所有的设计都是先整体后局部的思想，如果上来就卷起袖子干，不经过仔细的设计是干不好框架的，所以我们先画出SmartMVC的设计图，熟悉SpringMVC的小伙伴可能看出来了，这个流程和SpringMVC的一致。 <img src="https://raw.githubusercontent.com/silently9527/images/main/2287721208-5fbfce05acfeb_articlex" alt=""></p><p>SpringMVC之所以如此的受欢迎，其中很重要的一个原因是轻耦合可插拔的组件设计，提供很好的扩展性和灵活性。虽然我们即将要做的SmartMVC是SpringMVC的浓缩版本，但是SpingMVC有的核心组件我们也必须的有，否则无法让小伙伴更好的理解整个过程。</p><h4 id="_3-2-项目搭建" tabindex="-1">3.2 项目搭建 <a class="header-anchor" href="#_3-2-项目搭建" aria-label="Permalink to &quot;3.2 项目搭建&quot;">​</a></h4><p><img src="https://raw.githubusercontent.com/silently9527/images/main/896506658-5fc097c6f34e4_articlex" alt=""></p><p>smart-mvc项目中的pom.xml依赖引入</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;dependencies&gt;</span></span>
