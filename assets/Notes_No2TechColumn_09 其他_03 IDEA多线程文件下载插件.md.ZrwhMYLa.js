import{_ as a,c as n,o as s,aa as e}from"./chunks/framework.DOnJscRE.js";const m=JSON.parse('{"title":"03 IDEA多线程文件下载插件","description":"","frontmatter":{"title":"03 IDEA多线程文件下载插件","author":"Herman","updateTime":"2021-08-14 13:41","desc":"idea插件","categories":"MyProjects","tags":"idea插件","outline":"deep"},"headers":[],"relativePath":"Notes/No2TechColumn/09 其他/03 IDEA多线程文件下载插件.md","filePath":"Notes/No2TechColumn/09 其他/03 IDEA多线程文件下载插件.md","lastUpdated":1761049051000}'),p={name:"Notes/No2TechColumn/09 其他/03 IDEA多线程文件下载插件.md"},l=e(`<h2 id="摘要" tabindex="-1">摘要 <a class="header-anchor" href="#摘要" aria-label="Permalink to &quot;摘要&quot;">​</a></h2><p>上周使用Java开发了大文件多线程下载工具类，自己平时的文件下载也在使用这个工具，下载速度确实提升不少，但是每次下载都要去打开项目运行代码，觉得实在不是很方便；考虑到每天我们都会使用到IDEA开发工具，所以就决定把这个下载工具做成IDEA的插件，文章末尾附上插件下载地址。</p><blockquote><p>Java实现大文件多线程下载</p><ul><li>Gitee地址：<a href="https://gitee.com/silently9527/fast-download" target="_blank" rel="noreferrer">https://gitee.com/silently9527/fast-download</a></li></ul><p>IDEA多线程文件下载插件</p><ul><li>Github地址：<a href="https://github.com/silently9527/FastDownloadIdeaPlugin" target="_blank" rel="noreferrer">https://github.com/silently9527/FastDownloadIdeaPlugin</a></li><li>Gitee地址：<a href="https://gitee.com/silently9527/FastDownloadIdeaPlugin" target="_blank" rel="noreferrer">https://gitee.com/silently9527/FastDownloadIdeaPlugin</a></li></ul><p>不要忘记star哟</p></blockquote><h2 id="idea插件介绍" tabindex="-1">IDEA插件介绍 <a class="header-anchor" href="#idea插件介绍" aria-label="Permalink to &quot;IDEA插件介绍&quot;">​</a></h2><p>IntelliJ IDEA是目前最好用的JAVA开发IDE，它本身的功能已经非常强大了，但是可能我们会遇到一些定制的需求，比如说：自定义代码生成器；这时候就需要我们自己动手来写一个插件，如果只是想要开发简单的功能其实只要掌握了Java Swing，那么开发IDEA的插件是很容易的，如果想学习更多的原理和设计理念可以看<a href="https://www.jetbrains.org/intellij/sdk/docs/welcome.html" target="_blank" rel="noreferrer">IntelliJ Platform SDK</a>的官方文档。</p><h2 id="idea插件开发步骤" tabindex="-1">IDEA插件开发步骤 <a class="header-anchor" href="#idea插件开发步骤" aria-label="Permalink to &quot;IDEA插件开发步骤&quot;">​</a></h2><h4 id="_1-创建gradle的插件工程" tabindex="-1">1. 创建Gradle的插件工程 <a class="header-anchor" href="#_1-创建gradle的插件工程" aria-label="Permalink to &quot;1. 创建Gradle的插件工程&quot;">​</a></h4><p><img src="https://cdn.jsdelivr.net/gh/silently9527/images/b286f47138c04292b7540083f73f8f95%7Etplv-k3u1fbpfcp-watermark.image" alt=""></p><p>创建完成项目之后，我们可以看一下<code>resource/META-INF/plugin.xml</code></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;idea-plugin&gt;</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>最终界面完成后的效果</p><p><img src="https://cdn.jsdelivr.net/gh/silently9527/images/e55674d0d57a4cf1b6eac653c9972fee%7Etplv-k3u1fbpfcp-watermark.image" alt=""></p><h4 id="_4-在fastdownloadaction中获取弹窗输入的下载信息" tabindex="-1">4. 在FastDownloadAction中获取弹窗输入的下载信息 <a class="header-anchor" href="#_4-在fastdownloadaction中获取弹窗输入的下载信息" aria-label="Permalink to &quot;4. 在FastDownloadAction中获取弹窗输入的下载信息&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>DownloadDialog downloadDialog = new DownloadDialog();</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>});</span></span></code></pre></div><p><img src="https://cdn.jsdelivr.net/gh/silently9527/images/e91f510f11524ae7b31ada55c3556364%7Etplv-k3u1fbpfcp-watermark.image" alt=""></p><h2 id="测试多线程下载文件" tabindex="-1">测试多线程下载文件 <a class="header-anchor" href="#测试多线程下载文件" aria-label="Permalink to &quot;测试多线程下载文件&quot;">​</a></h2><p>测试下载820M的idea ，地址：<a href="https://download.jetbrains.8686c.com/idea/ideaIU-2020.3.dmg" target="_blank" rel="noreferrer">https://download.jetbrains.8686c.com/idea/ideaIU-2020.3.dmg</a></p><p><img src="https://cdn.jsdelivr.net/gh/silently9527/images/e7fba4ca172443ce9b92a7e8c5d089d3%7Etplv-k3u1fbpfcp-watermark.image" alt=""></p><h2 id="插件安装" tabindex="-1">插件安装 <a class="header-anchor" href="#插件安装" aria-label="Permalink to &quot;插件安装&quot;">​</a></h2><p>下载插件之后，选择本地安装</p><p><img src="https://cdn.jsdelivr.net/gh/silently9527/images/2a12851f10d146bfac988193c1b1c0a8%7Etplv-k3u1fbpfcp-watermark.image" alt=""></p><h2 id="总结" tabindex="-1">总结 <a class="header-anchor" href="#总结" aria-label="Permalink to &quot;总结&quot;">​</a></h2><ul><li>IDEA插件介绍</li><li>IDEA插件开发的基本步骤</li><li>实现了多线程文件下载插件</li></ul><blockquote><p>目前测试过程中发现文件下载速度计算不太准确，个别线程的下载速度未能统计在内，后期继续优化。</p><p>插件下载链接: <a href="https://pan.baidu.com/s/1cmzKgmu8JwUa-liWmNl5jw" target="_blank" rel="noreferrer">https://pan.baidu.com/s/1cmzKgmu8JwUa-liWmNl5jw</a> 提取码: 3f4t</p></blockquote>`,41),t=[l];function i(o,c,r,d,g,u){return s(),n("div",null,t)}const b=a(p,[["render",i]]);export{m as __pageData,b as default};
