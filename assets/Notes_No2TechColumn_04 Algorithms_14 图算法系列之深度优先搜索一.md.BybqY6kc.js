import{_ as s,c as a,o as n,aa as p}from"./chunks/framework.d_Ke7vMG.js";const m=JSON.parse('{"title":"14 图算法之深度优先搜索一","description":"","frontmatter":{"title":"14 图算法之深度优先搜索一","author":"Herman","updateTime":"2024-07-16 21:34","desc":"图算法系列之深度优先搜索一","categories":"算法","tags":"数据结构/深度优先搜索/图算法","outline":"deep"},"headers":[],"relativePath":"Notes/No2TechColumn/04 Algorithms/14 图算法系列之深度优先搜索一.md","filePath":"Notes/No2TechColumn/04 Algorithms/14 图算法系列之深度优先搜索一.md","lastUpdated":1724592993000}'),e={name:"Notes/No2TechColumn/04 Algorithms/14 图算法系列之深度优先搜索一.md"},l=p(`<h1 id="图算法系列之深度优先搜索-一" tabindex="-1">图算法系列之深度优先搜索（一） <a class="header-anchor" href="#图算法系列之深度优先搜索-一" aria-label="Permalink to &quot;图算法系列之深度优先搜索（一）&quot;">​</a></h1><h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>在上一篇中我们把图通过邻接表数组表示出来了，这个数据结构将会做我们实现图算法的基础，本篇我们将一起开始学习图算法的第一个搜索算法 - 深度优先搜索</p><h2 id="搜索api的定义" tabindex="-1">搜索API的定义 <a class="header-anchor" href="#搜索api的定义" aria-label="Permalink to &quot;搜索API的定义&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class Search {</span></span>
