import{_ as s,c as a,o as n,aa as p}from"./chunks/framework.DlhgB44u.js";const m=JSON.parse('{"title":"14 图算法之深度优先搜索一","description":"","frontmatter":{"title":"14 图算法之深度优先搜索一","author":"Herman","updateTime":"2024-07-16 21:34","desc":"图算法系列之深度优先搜索一","categories":"算法","tags":"数据结构/深度优先搜索/图算法","outline":"deep"},"headers":[],"relativePath":"Notes/No2TechColumn/04 Algorithms/14 图算法系列之深度优先搜索一.md","filePath":"Notes/No2TechColumn/04 Algorithms/14 图算法系列之深度优先搜索一.md","lastUpdated":1724595807000}'),e={name:"Notes/No2TechColumn/04 Algorithms/14 图算法系列之深度优先搜索一.md"},l=p(`<h1 id="图算法系列之深度优先搜索-一" tabindex="-1">图算法系列之深度优先搜索（一） <a class="header-anchor" href="#图算法系列之深度优先搜索-一" aria-label="Permalink to &quot;图算法系列之深度优先搜索（一）&quot;">​</a></h1><h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>在上一篇中我们把图通过邻接表数组表示出来了，这个数据结构将会做我们实现图算法的基础，本篇我们将一起开始学习图算法的第一个搜索算法 - 深度优先搜索</p><h2 id="搜索api的定义" tabindex="-1">搜索API的定义 <a class="header-anchor" href="#搜索api的定义" aria-label="Permalink to &quot;搜索API的定义&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class Search {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>在搜索一张图的时候，使用递归来遍历所有的顶点，在访问其中一个顶点时：</p><ol><li>标记它被已经访问</li><li>递归的访问与之相连的所有邻接点</li></ol><p><strong>单元测试：</strong> 构建下面这张图，然后测试深度优先搜索</p><p><img src="https://cdn.jsdelivr.net/gh/silently9527/images/7c7556f2ba204332b7d920d5b58c71d5%7Etplv-k3u1fbpfcp-zoom-1.image" alt=""></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>@Test</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>画图来详细跟踪深度优先搜索的运行轨迹，记录了edgeTo的变化以及父链树的逐渐形成</p><p><img src="https://cdn.jsdelivr.net/gh/silently9527/images/df521e755a8a4a2ab64e3647bfa37709%7Etplv-k3u1fbpfcp-zoom-1.image" alt=""></p><p><img src="https://cdn.jsdelivr.net/gh/silently9527/images/708c04bce39146e9bf37c1ada3fdeba3%7Etplv-k3u1fbpfcp-zoom-1.image" alt=""></p><p><img src="https://cdn.jsdelivr.net/gh/silently9527/images/80f4afebaec24bfba794dc66fca116de%7Etplv-k3u1fbpfcp-zoom-1.image" alt=""></p><p>最终父链树形成了，接下来我们来写单元测试校验下生成的父链树和实际的运行结果是否一致</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>@Test</span></span>
<span class="line"><span>public void test() {</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre></div><p>验证结果完全匹配了父链树</p><p><img src="https://cdn.jsdelivr.net/gh/silently9527/images/1cb5b06a5ebc4e318ac4d72e7114106b%7Etplv-k3u1fbpfcp-zoom-1.image" alt=""></p>`,35),i=[l];function t(c,r,h,d,o,g){return n(),a("div",null,i)}const b=s(e,[["render",t]]);export{m as __pageData,b as default};
