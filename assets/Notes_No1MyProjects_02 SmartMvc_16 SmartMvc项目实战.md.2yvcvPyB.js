import{_ as s,c as a,o as n,aa as e}from"./chunks/framework.DOnJscRE.js";const h=JSON.parse('{"title":"16 SmartMvc项目实战","description":"","frontmatter":{"title":"16 SmartMvc项目实战","author":"Herman","updateTime":"2021-08-14 13:41","desc":"深入解析SpringMVC核心原理：从手写简易版MVC框架开始(SmartMvc)","categories":"MyProjects","tags":"SpringMvc/MVC","outline":"deep"},"headers":[],"relativePath":"Notes/No1MyProjects/02 SmartMvc/16 SmartMvc项目实战.md","filePath":"Notes/No1MyProjects/02 SmartMvc/16 SmartMvc项目实战.md","lastUpdated":1723606122000}'),p={name:"Notes/No1MyProjects/02 SmartMvc/16 SmartMvc项目实战.md"},t=e(`<p>SmartMVC基本都功能都已完成，接下来我们就来做一个SmartMVC的项目实战，测试下SmartMVC是否能正常的工作。</p><h3 id="springboot项目中引入smartmvc的步骤" tabindex="-1">SpringBoot项目中引入SmartMVC的步骤 <a class="header-anchor" href="#springboot项目中引入smartmvc的步骤" aria-label="Permalink to &quot;SpringBoot项目中引入SmartMVC的步骤&quot;">​</a></h3><h4 id="_1-新建一个springboot项目-在pom-xml中加入smartmvc的starter" tabindex="-1">1. 新建一个SpringBoot项目，在pom.xml中加入SmartMVC的starter <a class="header-anchor" href="#_1-新建一个springboot项目-在pom-xml中加入smartmvc的starter" aria-label="Permalink to &quot;1. 新建一个SpringBoot项目，在pom.xml中加入SmartMVC的starter&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;dependency&gt;</span></span>
