import{_ as s,c as n,o as a,aa as p}from"./chunks/framework.d_Ke7vMG.js";const v=JSON.parse('{"title":"15 图算法之深度优先搜索二","description":"","frontmatter":{"title":"15 图算法之深度优先搜索二","author":"Herman","updateTime":"2024-07-16 21:34","desc":"图算法系列之深度优先搜索二","categories":"算法","tags":"数据结构/深度优先搜索/图算法","outline":"deep"},"headers":[],"relativePath":"Notes/No2TechColumn/04 Algorithms/15 图算法系列之深度优先搜索二.md","filePath":"Notes/No2TechColumn/04 Algorithms/15 图算法系列之深度优先搜索二.md","lastUpdated":1724593073000}'),l={name:"Notes/No2TechColumn/04 Algorithms/15 图算法系列之深度优先搜索二.md"},e=p(`<h1 id="图算法系列之深度优先搜索-二" tabindex="-1">图算法系列之深度优先搜索（二） <a class="header-anchor" href="#图算法系列之深度优先搜索-二" aria-label="Permalink to &quot;图算法系列之深度优先搜索（二）&quot;">​</a></h1><p>在上篇中我们学习了深度优先搜索，知道了如何通过深度优先搜索在图中寻找路径；本篇我们继续一起来学习深度优先搜索算法的其他应用场景</p><h2 id="连通分量" tabindex="-1">连通分量 <a class="header-anchor" href="#连通分量" aria-label="Permalink to &quot;连通分量&quot;">​</a></h2><p>从一幅图中找出所有的连通分量，这是也是深度优先搜索的一个应用场景。什么是连通分量？这个定义在之前的文章中已有提到<a href="https://juejin.cn/post/6930395454739841037" target="_blank" rel="noreferrer">《如何检测社交网络中两个人是否是朋友关系（union-find算法）》</a></p><p>在这篇采用的是union-find算法实现的连通性检查，本篇我们将采用深度优先搜索的方式来找出图中的所有连通分量</p><h4 id="连通分量的api定义" tabindex="-1">连通分量的API定义 <a class="header-anchor" href="#连通分量的api定义" aria-label="Permalink to &quot;连通分量的API定义&quot;">​</a></h4><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class DepthFirstCC {</span></span>
