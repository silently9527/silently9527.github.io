...
<span class="line"><span>    price = price * 1;</span></span>
<span class="line"><span>}</span></span>
<span class="line"><span>doSomething();</span></span></code></pre></div><p>当我们遇到try-catch中有相同的逻辑代码，我们也可以使用这种方式处理</p><hr><h4 id="卫语句取代嵌套条件表达式" tabindex="-1">卫语句取代嵌套条件表达式 <a class="header-anchor" href="#卫语句取代嵌套条件表达式" aria-label="Permalink to &quot;卫语句取代嵌套条件表达式&quot;">​</a></h4><p>方法中一旦出现很深的嵌套逻辑让人很难看懂执行的主线。当使用了<code>if-else</code>表示两个分支都是同等的重要，都是主线流程；向下图表达的一样， <img src="https://raw.githubusercontent.com/silently9527/images/main/3655225837-5fc78ef31a47a_articlex" alt=""></p><p>但是大多数时候我们会遇到只有一条主线流程，其他的都是个别的异常情况，在这种情况下使用<code>if-else</code>就不太合适，应该用卫语句取代嵌套表达式。 <img src="https://raw.githubusercontent.com/silently9527/images/main/3797382814-5fc78eb17cd1b_articlex" alt=""></p><p>举例1：</p><p>在薪酬系统中，以特殊的规则处理死亡员工，驻外员工，退休员工的薪资，这些情况都是很少出现，不属于正常逻辑；</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>double getPayAmount() {</span></span>
