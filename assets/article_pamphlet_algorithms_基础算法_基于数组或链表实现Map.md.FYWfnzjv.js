...
<span class="line"><span>    size--;</span></span>
<span class="line"><span>}</span></span></code></pre></div><blockquote><p>基于数组实现的Map，虽然get方法采用的二分查找法，很快O(logN)，但是在处理大量数据的情况下效率依然很低，因为put方法还是太慢；下篇我们将基于二叉树来实现Map，继续改进提升效率</p></blockquote>`,30);function x(s,f,_,N,C,M){const l=t,i=o("ClientOnly");return p(),d("div",null,[y,r(i,null,{default:u(()=>{var n,a;return[(((n=s.$frontmatter)==null?void 0:n.aside)??!0)&&(((a=s.$frontmatter)==null?void 0:a.showArticleMetadata)??!0)?(p(),m(l,{key:0,article:s.$frontmatter},null,8,["article"])):g("",!0)]}),_:1}),b])}const q=c(v,[["render",x]]);export{j as __pageData,q as default};
