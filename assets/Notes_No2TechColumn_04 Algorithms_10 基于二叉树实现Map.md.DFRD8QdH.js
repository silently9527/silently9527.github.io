import{_ as n,c as s,o as a,aa as p}from"./chunks/framework.d_Ke7vMG.js";const m=JSON.parse('{"title":"10 基于二叉树实现Map","description":"","frontmatter":{"title":"10 基于二叉树实现Map","author":"Herman","updateTime":"2024-07-16 21:34","desc":"基于二叉树实现Map","categories":"算法","tags":"数据结构/二叉树","outline":"deep"},"headers":[],"relativePath":"Notes/No2TechColumn/04 Algorithms/10 基于二叉树实现Map.md","filePath":"Notes/No2TechColumn/04 Algorithms/10 基于二叉树实现Map.md","lastUpdated":1723563552000}'),e={name:"Notes/No2TechColumn/04 Algorithms/10 基于二叉树实现Map.md"},l=p(`<h1 id="基于二叉树实现map" tabindex="-1">基于二叉树实现Map <a class="header-anchor" href="#基于二叉树实现map" aria-label="Permalink to &quot;基于二叉树实现Map&quot;">​</a></h1><h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>在上一篇中我们基于数组和链表实现了Map的相关操作，但是对于数据量稍大的情况下，这两种实现方式效率都比较低，为了改进这个问题，本篇我们将来学习二叉树，并通过二叉树来实现上一篇中定义的Map结构</p><h2 id="二叉树简介" tabindex="-1">二叉树简介 <a class="header-anchor" href="#二叉树简介" aria-label="Permalink to &quot;二叉树简介&quot;">​</a></h2><p>虽然大家都知道二叉树是什么，但是为了保证文章的完整性，这里还是简单说说什么是二叉树</p><p>二叉树中每个节点都包含了两个指针指向自己的左子树和右子树。</p><p>二叉树的每个节点都包含了一个Key, 并且每个节点的Key都大于其左子树中的任意节点，小于右子树中的任意节点。</p><p><img src="https://raw.githubusercontent.com/silently9527/images/main/28f4367ecbfb422bb9ff087cc681126e%7Etplv-k3u1fbpfcp-zoom-1.image" alt=""></p><p>节点的数据结构定义：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>class Node {</span></span>
