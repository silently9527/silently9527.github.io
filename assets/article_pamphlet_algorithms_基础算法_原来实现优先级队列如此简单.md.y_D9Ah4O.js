import{_ as s,o as a,c as n,R as p}from"./chunks/framework.412fhWlr.js";const b=JSON.parse('{"title":"原来实现优先级队列如此简单","description":"","frontmatter":{"title":"原来实现优先级队列如此简单","author":"Herman","date":"2021/08/14 13:58","categories":["算法"],"tags":["数据结构","二叉堆"]},"headers":[],"relativePath":"article/pamphlet/algorithms/基础算法/原来实现优先级队列如此简单.md","filePath":"article/pamphlet/algorithms/基础算法/原来实现优先级队列如此简单.md","lastUpdated":1723373794000}'),e={name:"article/pamphlet/algorithms/基础算法/原来实现优先级队列如此简单.md"},l=p(`<h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>假如你设计的事件系统中有很多的事件，每个事件都定义了不同的权重值，系统需要优先处理权重较高的事件，这里你就需要使用到优先级队列，本篇我们一起来学习实现优先级队列的常用方式</p><h2 id="队列api定义" tabindex="-1">队列API定义 <a class="header-anchor" href="#队列api定义" aria-label="Permalink to &quot;队列API定义&quot;">​</a></h2><p>在实现之前，首先我们需要先定义出优先级队的API，优先级队列是一种抽象的数据结构，我们依然可以基于前面我们使用到的队列API来修改；需要了解之前的队列的实现可以查看《面试的季节到了，老哥确定不来复习下数据结构吗》</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>public interface Queue&lt;T&gt; extends Iterable&lt;T&gt; {</span></span>
