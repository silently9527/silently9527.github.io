import{_ as t}from"./chunks/ArticleMetadata.4oKRY2Hc.js";import{_ as r,D as c,o as p,c as o,I as h,w as m,k as l,a as d,R as g,b as u,e as b}from"./chunks/framework.YqjYndaU.js";import"./chunks/md5.wJRuYMDo.js";const P=JSON.parse('{"title":"常见的初级排序算法，这次全搞懂","description":"","frontmatter":{"title":"常见的初级排序算法，这次全搞懂","author":"Herman","date":"2021/08/14 13:58","categories":["算法"],"tags":["数据结构","排序算法"]},"headers":[],"relativePath":"article/pamphlet/algorithms/卧学算法/04-常见的初级排序算法，这次全搞懂.md","filePath":"article/pamphlet/algorithms/卧学算法/04-常见的初级排序算法，这次全搞懂.md","lastUpdated":1723429417000}'),_={name:"article/pamphlet/algorithms/卧学算法/04-常见的初级排序算法，这次全搞懂.md"},f=l("h1",{id:"常见的初级排序算法-这次全搞懂",tabindex:"-1"},[d("常见的初级排序算法，这次全搞懂 "),l("a",{class:"header-anchor",href:"#常见的初级排序算法-这次全搞懂","aria-label":'Permalink to "常见的初级排序算法，这次全搞懂"'},"​")],-1),y=g(`<h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>相信所有的程序员刚开始接触到的算法都会是排序算法，因为排序在对数据处理和计算有这重要的地位，排序算法往往是其他算法的基础；本文我们就先从初级排序算法开始学习算法。</p><h2 id="排序算法的模板" tabindex="-1">排序算法的模板 <a class="header-anchor" href="#排序算法的模板" aria-label="Permalink to &quot;排序算法的模板&quot;">​</a></h2><p>在开始之前我们先定义一个排序算法通用的模板，在后面的排序算法都会实现这个模板</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>public interface SortTemplate {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre></div>`,40);function v(a,k,C,j,S,x){const e=t,i=c("ClientOnly");return p(),o("div",null,[f,h(i,null,{default:m(()=>{var s,n;return[(((s=a.$frontmatter)==null?void 0:s.aside)??!0)&&(((n=a.$frontmatter)==null?void 0:n.showArticleMetadata)??!0)?(p(),u(e,{key:0,article:a.$frontmatter},null,8,["article"])):b("",!0)]}),_:1}),y])}const O=r(_,[["render",v]]);export{P as __pageData,O as default};
