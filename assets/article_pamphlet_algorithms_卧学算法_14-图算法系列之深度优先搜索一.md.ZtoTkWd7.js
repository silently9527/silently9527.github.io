import{_ as i}from"./chunks/ArticleMetadata.XuUbZ1GH.js";import{_ as c,D as r,o as p,c as o,I as h,w as d,k as e,a as g,R as m,b as u,e as b}from"./chunks/framework.PNf1_BA9.js";import"./chunks/md5.c4H53MUT.js";const q=JSON.parse('{"title":"图算法系列之深度优先搜索（一）","description":"","frontmatter":{"title":"图算法系列之深度优先搜索（一）","author":"Herman","date":"2021/08/14 13:58","categories":["算法"],"tags":["深度优先搜索","图算法"]},"headers":[],"relativePath":"article/pamphlet/algorithms/卧学算法/14-图算法系列之深度优先搜索一.md","filePath":"article/pamphlet/algorithms/卧学算法/14-图算法系列之深度优先搜索一.md","lastUpdated":1723429417000}'),v={name:"article/pamphlet/algorithms/卧学算法/14-图算法系列之深度优先搜索一.md"},f=e("h1",{id:"图算法系列之深度优先搜索-一",tabindex:"-1"},[g("图算法系列之深度优先搜索（一） "),e("a",{class:"header-anchor",href:"#图算法系列之深度优先搜索-一","aria-label":'Permalink to "图算法系列之深度优先搜索（一）"'},"​")],-1),k=m(`<h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>在上一篇中我们把图通过邻接表数组表示出来了，这个数据结构将会做我们实现图算法的基础，本篇我们将一起开始学习图算法的第一个搜索算法 - 深度优先搜索</p><h2 id="搜索api的定义" tabindex="-1">搜索API的定义 <a class="header-anchor" href="#搜索api的定义" aria-label="Permalink to &quot;搜索API的定义&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>public class Search {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>在搜索一张图的时候，使用递归来遍历所有的顶点，在访问其中一个顶点时：</p><ol><li>标记它被已经访问</li><li>递归的访问与之相连的所有邻接点</li></ol><p><strong>单元测试：</strong> 构建下面这张图，然后测试深度优先搜索</p><p><img src="https://raw.githubusercontent.com/silently9527/images/main/7c7556f2ba204332b7d920d5b58c71d5%7Etplv-k3u1fbpfcp-zoom-1.image" alt=""></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>@Test</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre></div><p>验证结果完全匹配了父链树</p><p><img src="https://raw.githubusercontent.com/silently9527/images/main/1cb5b06a5ebc4e318ac4d72e7114106b%7Etplv-k3u1fbpfcp-zoom-1.image" alt=""></p>`,34);function _(a,y,w,E,T,S){const l=i,t=r("ClientOnly");return p(),o("div",null,[f,h(t,null,{default:d(()=>{var s,n;return[(((s=a.$frontmatter)==null?void 0:s.aside)??!0)&&(((n=a.$frontmatter)==null?void 0:n.showArticleMetadata)??!0)?(p(),u(l,{key:0,article:a.$frontmatter},null,8,["article"])):b("",!0)]}),_:1}),k])}const D=c(v,[["render",_]]);export{q as __pageData,D as default};
