import{_ as n,c as a,o as s,aa as e}from"./chunks/framework.d_Ke7vMG.js";const m=JSON.parse('{"title":"08 HandlerAdapter","description":"","frontmatter":{"title":"08 HandlerAdapter","author":"Herman","updateTime":"2021-08-14 13:41","desc":"深入解析SpringMVC核心原理：从手写简易版MVC框架开始(SmartMvc)","categories":"MyProjects","tags":"SpringMvc/MVC","outline":"deep"},"headers":[],"relativePath":"Notes/No1MyProjects/02 SmartMvc/08 HandlerAdapter - 实现RequestMappingHandlerAdapter.md","filePath":"Notes/No1MyProjects/02 SmartMvc/08 HandlerAdapter - 实现RequestMappingHandlerAdapter.md","lastUpdated":1724592993000}'),p={name:"Notes/No1MyProjects/02 SmartMvc/08 HandlerAdapter - 实现RequestMappingHandlerAdapter.md"},l=e(`<p>本篇我们来完成<code>HandlerAdapter</code>的实现类<code>RequestMappingHandlerAdapter</code>，这也是<code>HandlerAdpater</code>的最后一节。先看看类图</p><p><img src="https://cdn.jsdelivr.net/gh/silently9527/images//1181981758-5fcf8588e5f60_articlex" alt=""></p><p><code>RequestMappingHandlerAdapter</code>本身在SpringMVC中占有重要的地位，虽然它只是<code>HandlerAdapter</code>的一种实现，但是它是使用最多的一个实现类，主要用于将某个请求适配给<code>@RequestMapping</code>类型的Handler处理</p><h4 id="_10-1-开发步骤讲解" tabindex="-1">10.1 开发步骤讲解 <a class="header-anchor" href="#_10-1-开发步骤讲解" aria-label="Permalink to &quot;10.1 开发步骤讲解&quot;">​</a></h4><blockquote><p>本节源代码的分支：handlerAdapter-requestMappingHandlerAdapter</p></blockquote><h5 id="handleradapter" tabindex="-1">HandlerAdapter <a class="header-anchor" href="#handleradapter" aria-label="Permalink to &quot;HandlerAdapter&quot;">​</a></h5><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public interface HandlerAdapter {</span></span>
