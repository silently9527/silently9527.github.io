import{_ as a,c as s,o as n,aa as p}from"./chunks/framework.d_Ke7vMG.js";const u=JSON.parse('{"title":"04 常见的初级排序算法，这次全搞懂","description":"","frontmatter":{"title":"04 常见的初级排序算法，这次全搞懂","author":"Herman","updateTime":"2024-07-16 21:34","desc":"常见的初级排序算法，这次全搞懂","categories":"算法","tags":"数据结构/排序算法","outline":"deep"},"headers":[],"relativePath":"Notes/Algorithms/04 常见的初级排序算法，这次全搞懂.md","filePath":"Notes/Algorithms/04 常见的初级排序算法，这次全搞懂.md","lastUpdated":1723551387000}'),l={name:"Notes/Algorithms/04 常见的初级排序算法，这次全搞懂.md"},e=p(`<h1 id="常见的初级排序算法-这次全搞懂" tabindex="-1">常见的初级排序算法，这次全搞懂 <a class="header-anchor" href="#常见的初级排序算法-这次全搞懂" aria-label="Permalink to &quot;常见的初级排序算法，这次全搞懂&quot;">​</a></h1><h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>相信所有的程序员刚开始接触到的算法都会是排序算法，因为排序在对数据处理和计算有这重要的地位，排序算法往往是其他算法的基础；本文我们就先从初级排序算法开始学习算法。</p><h2 id="排序算法的模板" tabindex="-1">排序算法的模板 <a class="header-anchor" href="#排序算法的模板" aria-label="Permalink to &quot;排序算法的模板&quot;">​</a></h2><p>在开始之前我们先定义一个排序算法通用的模板，在后面的排序算法都会实现这个模板</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public interface SortTemplate {</span></span>
