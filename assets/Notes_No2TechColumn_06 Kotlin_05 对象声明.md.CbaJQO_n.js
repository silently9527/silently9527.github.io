import{_ as a,c as n,o as s,aa as e}from"./chunks/framework.DOnJscRE.js";const _=JSON.parse('{"title":"05 对象声明","description":"","frontmatter":{"title":"05 对象声明","author":"Herman","updateTime":"2024-09-18 12:34","desc":"Kotlin 基础入门","categories":"Kotlin","tags":"Kotlin","outline":"deep"},"headers":[],"relativePath":"Notes/No2TechColumn/06 Kotlin/05 对象声明.md","filePath":"Notes/No2TechColumn/06 Kotlin/05 对象声明.md","lastUpdated":1761191963000}'),p={name:"Notes/No2TechColumn/06 Kotlin/05 对象声明.md"},t=e(`<h4 id="对象声明" tabindex="-1">对象声明 <a class="header-anchor" href="#对象声明" aria-label="Permalink to &quot;对象声明&quot;">​</a></h4><p>单例对象在面向对象编程中很常见, 在Java中通常都是使用单例模式来实现的, 在Kotlin中可以简单的使用一个 <code>object</code> 关键字来实现, <code>object</code> 表示定义一个类并且同时创建一个实例,所以使用<code>object</code>标记的类其实就是一个对象, 先来看个例子</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>data class User(val name: String)</span></span>
...
<span class="line"><span>        }</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>注意看上面的例子,如果不是使用伴生对象是没有办法访问到User的私有构造方法和私有变量; 伴生对象的名字可以省略,默认的名字将会是<code>Companion</code></p><p>原文链接: <a href="http://herman7z.site" target="_blank" rel="noreferrer">http://herman7z.site</a></p>`,17),l=[t];function i(o,c,r,d,u,h){return s(),n("div",null,l)}const b=a(p,[["render",i]]);export{_ as __pageData,b as default};
