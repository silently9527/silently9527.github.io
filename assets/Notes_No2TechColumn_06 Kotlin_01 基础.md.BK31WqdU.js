import{_ as a,c as s,o as n,aa as p}from"./chunks/framework.DOnJscRE.js";const v=JSON.parse('{"title":"01 基础","description":"","frontmatter":{"title":"01 基础","author":"Herman","updateTime":"2024-09-10 21:34","desc":"Kotlin 基础入门","categories":"Kotlin","tags":"Kotlin","outline":"deep"},"headers":[],"relativePath":"Notes/No2TechColumn/06 Kotlin/01 基础.md","filePath":"Notes/No2TechColumn/06 Kotlin/01 基础.md","lastUpdated":1761052119000}'),e={name:"Notes/No2TechColumn/06 Kotlin/01 基础.md"},t=p(`<h4 id="变量" tabindex="-1">变量 <a class="header-anchor" href="#变量" aria-label="Permalink to &quot;变量&quot;">​</a></h4><p>Kotlin声明变量的关键字有两个</p><ul><li>val: 不可变引用，相当于java中final修饰的变量</li><li>var: 可变引用</li></ul><p>举例：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>val name:String = &quot;Herman&quot;;</span></span>
