import{_ as i}from"./chunks/ArticleMetadata.IwlMn1X8.js";import{_ as c,D as r,o as e,c as o,I as h,w as d,k as s,a as g,R as u,b as m,e as v}from"./chunks/framework.412fhWlr.js";import"./chunks/md5.6OGdLw3O.js";const B=JSON.parse('{"title":"图算法系列之计算图中最短路径","description":"","frontmatter":{},"headers":[],"relativePath":"article/pamphlet/algorithms/基础算法/图算法系列之计算图中最短路径.md","filePath":"article/pamphlet/algorithms/基础算法/图算法系列之计算图中最短路径.md","lastUpdated":1723377986000}'),k={name:"article/pamphlet/algorithms/基础算法/图算法系列之计算图中最短路径.md"},b=s("p",null,"****--- title: 图算法系列之计算图中最短路径 author: Herman date: 2021/08/14 13:58 categories:",-1),y=s("ul",null,[s("li",null,"算法 tags:"),s("li",null,"广度优先搜索"),s("li",null,"图算法 ---****")],-1),_=s("h1",{id:"图算法系列之计算图中最短路径",tabindex:"-1"},[g("图算法系列之计算图中最短路径 "),s("a",{class:"header-anchor",href:"#图算法系列之计算图中最短路径","aria-label":'Permalink to "图算法系列之计算图中最短路径"'},"​")],-1),q=u(`<blockquote><p>吐血整理程序员必读书单：<a href="https://github.com/silently9527/ProgrammerBooks" target="_blank" rel="noreferrer">https://github.com/silently9527/ProgrammerBooks</a></p><p>微信公众号：贝塔学Java</p></blockquote><h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>在前面两篇中我们通过深度优先搜索可以从图中找出一条通过顶点v到顶点w的路径，但是深度优先搜索与顶点的输入有很大的关系，找出来的路径也不一定是最短的，通常情况下我们很多时候需要找出图中的最短路径，比如：地图功能。这里我们就需要使用到广度优先搜索算法</p><h2 id="广度优先搜索" tabindex="-1">广度优先搜索 <a class="header-anchor" href="#广度优先搜索" aria-label="Permalink to &quot;广度优先搜索&quot;">​</a></h2><p>依然使用之前定义的寻找路径的API</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>public class Paths {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>以下图为列，来看看广度优先搜索的运行轨迹</p><p><img src="https://tva1.sinaimg.cn/large/008i3skNgy1gq7c2hu6ttj309i06s3yp.jpg" alt=""></p><p><img src="https://tva1.sinaimg.cn/large/008i3skNgy1gq7c41v2m8j30q30jm0va.jpg" alt=""></p><p>单元测试的代码：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>@Test</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,27);function S(a,f,T,P,w,E){const l=i,t=r("ClientOnly");return e(),o("div",null,[b,y,_,h(t,null,{default:d(()=>{var n,p;return[(((n=a.$frontmatter)==null?void 0:n.aside)??!0)&&(((p=a.$frontmatter)==null?void 0:p.showArticleMetadata)??!0)?(e(),m(l,{key:0,article:a.$frontmatter},null,8,["article"])):v("",!0)]}),_:1}),q])}const G=c(k,[["render",S]]);export{B as __pageData,G as default};
