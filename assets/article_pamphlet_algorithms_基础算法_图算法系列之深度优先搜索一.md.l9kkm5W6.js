import{_ as t}from"./chunks/ArticleMetadata.IwlMn1X8.js";import{_ as c,D as r,o as p,c as h,I as o,w as d,k as e,a as g,R as m,b as u,e as v}from"./chunks/framework.412fhWlr.js";import"./chunks/md5.6OGdLw3O.js";const C=JSON.parse('{"title":"图算法系列之深度优先搜索（一）","description":"","frontmatter":{"title":"图算法系列之深度优先搜索（一）","author":"Herman","date":"2021/08/14 13:58","categories":["算法"],"tags":["深度优先搜索","图算法"]},"headers":[],"relativePath":"article/pamphlet/algorithms/基础算法/图算法系列之深度优先搜索一.md","filePath":"article/pamphlet/algorithms/基础算法/图算法系列之深度优先搜索一.md","lastUpdated":1723377986000}'),b={name:"article/pamphlet/algorithms/基础算法/图算法系列之深度优先搜索一.md"},k=e("h1",{id:"图算法系列之深度优先搜索-一",tabindex:"-1"},[g("图算法系列之深度优先搜索（一） "),e("a",{class:"header-anchor",href:"#图算法系列之深度优先搜索-一","aria-label":'Permalink to "图算法系列之深度优先搜索（一）"'},"​")],-1),_=m(`<h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>在上一篇中我们把图通过邻接表数组表示出来了，这个数据结构将会做我们实现图算法的基础，本篇我们将一起开始学习图算法的第一个搜索算法 - 深度优先搜索</p><h2 id="搜索api的定义" tabindex="-1">搜索API的定义 <a class="header-anchor" href="#搜索api的定义" aria-label="Permalink to &quot;搜索API的定义&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>public class Search {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>画图来详细跟踪深度优先搜索的运行轨迹，记录了edgeTo的变化以及父链树的逐渐形成</p><p><img src="https://tva1.sinaimg.cn/large/008eGmZEgy1gpn6aa26xbj30so0k3q3b.jpg" alt=""></p><p><img src="https://tva1.sinaimg.cn/large/008eGmZEgy1gpn6bk76q6j30pm0hd0t0.jpg" alt=""></p><p><img src="https://tva1.sinaimg.cn/large/008eGmZEgy1gpn6buam0tj30qk08g3yi.jpg" alt=""></p><p>最终父链树形成了，接下来我们来写单元测试校验下生成的父链树和实际的运行结果是否一致</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>@Test</span></span>
<span class="line"><span>public void test() {</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre></div><p>验证结果完全匹配了父链树</p><p><img src="https://tva1.sinaimg.cn/large/008eGmZEgy1gpn6fopotij30fs07na9y.jpg" alt=""></p>`,34);function f(a,y,E,T,S,P){const l=t,i=r("ClientOnly");return p(),h("div",null,[k,o(i,null,{default:d(()=>{var s,n;return[(((s=a.$frontmatter)==null?void 0:s.aside)??!0)&&(((n=a.$frontmatter)==null?void 0:n.showArticleMetadata)??!0)?(p(),u(l,{key:0,article:a.$frontmatter},null,8,["article"])):v("",!0)]}),_:1}),_])}const G=c(b,[["render",f]]);export{C as __pageData,G as default};
