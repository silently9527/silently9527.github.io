import{_ as s,o as n,c as a,R as p}from"./chunks/framework.412fhWlr.js";const m=JSON.parse('{"title":"图算法系列之计算图中最短路径","description":"","frontmatter":{"title":"图算法系列之计算图中最短路径","date":"2021-08-14T14:01:13.501Z","updated":"2021-08-15T11:57:19.849Z","url":"/?p=55","categories":"算法","tags":"图算法 | 广度优先搜索"},"headers":[],"relativePath":"article/pamphlet/algorithms/基础算法/图算法系列之计算图中最短路径.md","filePath":"article/pamphlet/algorithms/基础算法/图算法系列之计算图中最短路径.md","lastUpdated":1723371853000}'),e={name:"article/pamphlet/algorithms/基础算法/图算法系列之计算图中最短路径.md"},l=p(`<blockquote><p>吐血整理程序员必读书单：<a href="https://github.com/silently9527/ProgrammerBooks" target="_blank" rel="noreferrer">https://github.com/silently9527/ProgrammerBooks</a></p><p>微信公众号：贝塔学Java</p></blockquote><h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>在前面两篇中我们通过深度优先搜索可以从图中找出一条通过顶点v到顶点w的路径，但是深度优先搜索与顶点的输入有很大的关系，找出来的路径也不一定是最短的，通常情况下我们很多时候需要找出图中的最短路径，比如：地图功能。这里我们就需要使用到广度优先搜索算法</p><h2 id="广度优先搜索" tabindex="-1">广度优先搜索 <a class="header-anchor" href="#广度优先搜索" aria-label="Permalink to &quot;广度优先搜索&quot;">​</a></h2><p>依然使用之前定义的寻找路径的API</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>public class Paths {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,27),i=[l];function t(c,r,h,o,g,d){return n(),a("div",null,i)}const v=s(e,[["render",t]]);export{m as __pageData,v as default};
