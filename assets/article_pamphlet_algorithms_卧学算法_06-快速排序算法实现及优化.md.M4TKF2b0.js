import{_ as t}from"./chunks/ArticleMetadata.XuUbZ1GH.js";import{_ as r,D as c,o as p,c as o,I as h,w as d,k as l,a as u,R as m,b as g,e as b}from"./chunks/framework.PNf1_BA9.js";import"./chunks/md5.c4H53MUT.js";const T=JSON.parse('{"title":"快速排序算法实现及优化","description":"","frontmatter":{"title":"快速排序算法实现及优化","author":"Herman","date":"2021/08/14 13:58","categories":["算法"],"tags":["数据结构","排序算法"]},"headers":[],"relativePath":"article/pamphlet/algorithms/卧学算法/06-快速排序算法实现及优化.md","filePath":"article/pamphlet/algorithms/卧学算法/06-快速排序算法实现及优化.md","lastUpdated":1723429417000}'),y={name:"article/pamphlet/algorithms/卧学算法/06-快速排序算法实现及优化.md"},_=l("h1",{id:"快速排序算法实现及优化",tabindex:"-1"},[u("快速排序算法实现及优化 "),l("a",{class:"header-anchor",href:"#快速排序算法实现及优化","aria-label":'Permalink to "快速排序算法实现及优化"'},"​")],-1),k=m(`<h2 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h2><p>快速排序可以说是使用最广的排序算法了，主要的特点是基于原地排序（不需要使用辅助数组，节省空间）；其实对于长度为N的数组使用快速排序时间复杂度为 NlogN；在前几篇也一起讨论了其他的排序算法，都没能够把这两个特点结合起来。</p><h2 id="快速排序思路" tabindex="-1">快速排序思路 <a class="header-anchor" href="#快速排序思路" aria-label="Permalink to &quot;快速排序思路&quot;">​</a></h2><p>快速排序也是一种分治的排序算法，把数组划分为两个子数组，然后递归对子数组进行排序，最终保证整个数组有序。</p><p>算法思路：</p><ol><li>随机选择一个切分元素，通常选择的是数组的第一个元素</li><li>从数组的左边开始扫描找出大于等于切分元素的值，从数组的右边开始扫描找出小于等于切分元素的值，交换这两个值</li><li>循环这个过程直到左右两个指针相遇，这样就排定了一个元素，保证了切分元素左边的值都是小于它的值，右边的元素都是大于它的值</li><li>递归这个过程，最终保证整个数组有序</li></ol><h2 id="算法实现" tabindex="-1">算法实现 <a class="header-anchor" href="#算法实现" aria-label="Permalink to &quot;算法实现&quot;">​</a></h2><p>根据快速排序算法的思路，我们可以写出第一版实现：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>public class QuickSort implements SortTemplate {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><blockquote><p>其中<code>exch</code> 、<code>less</code>方法的实现请看之前的文章《常见的初级排序算法，这次全搞懂》</p></blockquote><p>这段代码是实现快速排序的常规实现，考虑最糟糕的情况，假如需要排序的数组是已经有序的[1,2,3,4,5,6,7,8]，执行快速排序的过程如图：</p><p><img src="https://raw.githubusercontent.com/silently9527/images/main/cb03927c97b54ebca0c2432c98d1c566%7Etplv-k3u1fbpfcp-zoom-1.image" alt=""></p><p>对一个长度为N的数组，最糟糕的情况下需要递归N-1次，所以时间复杂度是O(n²)，为了避免这种情况出现，我们来看下算法如何改进</p><h2 id="算法改进" tabindex="-1">算法改进 <a class="header-anchor" href="#算法改进" aria-label="Permalink to &quot;算法改进&quot;">​</a></h2><ul><li>保证随机性 为了避免最糟糕的情况出现，有两个办法，第一是在排序数组之前先随机打乱数组；第二是在partition方法中随机取切分元素，而不是固定取第一个，简单实现：</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>private int partition(Comparable[] array, int lo, int hi) {</span></span>
<span class="line"><span>    int i = lo, j = hi + 1;</span></span>
...
<span class="line"><span>    exch(array, lo, j);</span></span>
<span class="line"><span>    return j;</span></span>
<span class="line"><span>}</span></span></code></pre></div><ul><li>切换到插入排序 这点和归并排序一样，对于小数组的排序直接切换成插入排序</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark-dimmed vp-code"><code><span class="line"><span>private void quickSort(Comparable[] array, int lo, int hi) {</span></span>
<span class="line"><span>    if (lo &gt;= hi) {</span></span>
<span class="line"><span>        return;</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>    </span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,23);function v(a,f,C,q,S,j){const i=t,e=c("ClientOnly");return p(),o("div",null,[_,h(e,null,{default:d(()=>{var n,s;return[(((n=a.$frontmatter)==null?void 0:n.aside)??!0)&&(((s=a.$frontmatter)==null?void 0:s.showArticleMetadata)??!0)?(p(),g(i,{key:0,article:a.$frontmatter},null,8,["article"])):b("",!0)]}),_:1}),k])}const P=r(y,[["render",v]]);export{T as __pageData,P as default};
